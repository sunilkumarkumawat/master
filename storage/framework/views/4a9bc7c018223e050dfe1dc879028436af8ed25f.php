...
<input type="hidden" id="value2">
    <section class="content pt-3">
        <div class="container-fluid">
            ...
            <p><i class="fa fa-dot-circle-o"></i> Student Details</p>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <a href="<?php echo e(url('admissionView')); ?>">
                        <div class="info-box mb-3 text-dark">
                            <span class="info-box-icon bg-success elevation-1"><i
                                    class="fa fa-graduation-cap"></i></span>
                            <div class="info-box-content">
                                <span class="info-box-text"><?php echo e(__('dashboard.TOTAL STUDENTS')); ?></span>
                                <span class="info-box-number"><?php echo e(App\Models\Admission::countActiveAdmission()); ?></span>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-12 col-sm-6 col-md-3">
                    <a href="<?php echo e(url('studentsAttendanceView')); ?>">
                        <div class="info-box mb-3 text-dark">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text"><?php echo e(__('dashboard.PRESENT STUDENTS')); ?></span>
                                <span class="info-box-number"><?php echo e(\App\Models\StudentAttendance::countPresentStudents()); ?></span>
                            </div>
                        </div>
                    </a>
                </div>
                 <div class="col-12 col-sm-6 col-md-3">
                        <div class="info-box mb-3 text-dark">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text"><?php echo e(__('dashboard.FEES COLLECTION')); ?></span>
                                <span class="info-box-number"><i class="fa fa-rupee"></i>
                                    <?php echo e(number_format(\App\Models\FeesDetail::totalCollection() ,2) ?? ''); ?></span>
                            </div>
                        </div>
             ...
             <div class="col-12 col-sm-6 col-md-3">
           <form id="myForm" action="<?php echo e(url('fees/index')); ?>" method="post">
                <?php echo csrf_field(); ?>  
                <input type="hidden" class="form-control" id="starting" name="starting" value="<?php echo e(date('Y-m-d')); ?>">
                <input type="hidden" class="form-control" id="ending" name="ending" value="<?php echo e(date('Y-m-d')); ?>">
                <div class="info-box mb-3 text-dark" onclick="submitForm()">
                    ...
                    <div class="info-box-content">
                       <button type="submit" class="bg-white" style="border:hidden;text-align:left"> <span class="info-box-text"><?php echo e(__('dashboard.TODAY COLLECTION')); ?></span></button>
                        <span class="info-box-number"><i class="fa fa-rupee"></i>
                            <?php echo e(number_format(\App\Models\FeesDetail::todayCollection(), 2) ?? ''); ?>
        ...
        <div class="row">
            <p><i class="fa fa-dot-circle-o"></i> <?php echo e(__('dashboard.User Details')); ?> </p>
            </div>
                   ...
                   <div class="col-12 col-sm-6 col-md-3">
                    <a href="<?php echo e(url('viewUser')); ?>">
                        <div class="info-box mb-3 text-dark">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text"><?php echo e(__('dashboard.TOTAL USERS')); ?></span>
                                <span class="info-box-number"><?php echo e(\App\Models\User::countUser() ?? '0'); ?></span>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-12 col-sm-6 col-md-3">
                    <a href="<?php echo e(url('teachers/index')); ?>">
                        <div class="info-box mb-3 text-dark">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text"><?php echo e(__('dashboard.TOTAL TEACHERS')); ?></span>
                                <span class="info-box-number"><?php echo e(\App\Models\Teacher::countTeacher()); ?></span>
                            </div>
                        </div>
                    </a>
                </div>
                  <div class="col-12 col-sm-6 col-md-3">
                    <a href="<?php echo e(url('staff/Attendance/view')); ?>">
                        <div class="info-box mb-3 text-dark">
                            <span class="info-box-icon bg-warning elevation-1"><i class="ion ion-stats-bars"></i></span>
                            <div class="info-box-content">
                                <span class="info-box-text"><?php echo e(__('dashboard.PRESENT TEACHERS')); ?></span>
                                <span class="info-box-number"><?php echo e(\App\Models\TeacherAttendance::countTeacherAttendance()); ?></span>
                            </div>
                        </div>
                    </a>
                </div>
   <!--             <div class="col-12 col-sm-6 col-md-3">
                    <a href="<?php echo e(url('bank/account/index')); ?>">
                        <div class="info-box mb-3 text-dark">
                            <span class="info-box-icon bg-danger elevation-1"><i class="fa fa-bank"></i></span>
                            <div class="info-box-content">
                                <span class="info-box-text"><?php echo e(__('dashboard.TOTAL ACCOUNTS')); ?></span>
                                <span class="info-box-number"><?php echo e(\App\Models\Account::countAccount()); ?></span>
                            </div>
                        </div>
                    </a>
                </div>-->
          <!--      <div class="col-12 col-sm-6 col-md-3">
                    <a href="<?php echo e(url('invantory_dashboard')); ?>">
                        <div class="info-box mb-3 text-dark">
                            <span class="info-box-icon bg-danger elevation-1"><i class="fa fa-archive"></i></span>
                            <div class="info-box-content">
                                <span class="info-box-text"><?php echo e(__('dashboard.INVENTORY')); ?></span>
            ...
            <!--  <div class="col-12 col-sm-6 col-md-3">
                    <a href="<?php echo e(url('complaint_view')); ?>">
                        <div class="info-box mb-3 text-dark">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text"><?php echo e(__('dashboard.TOTAL COMPLAINTS')); ?></span>
                                <span class="info-box-number"><?php echo e(\App\Models\Master\Complaint::countComplaint()); ?></span>
                            </div>
                        </div>
                    </a>
                </div>-->
                 <div class="col-12 col-sm-6 col-md-3">
                    <a href="<?php echo e(url('expenseView')); ?>">
                        <div class="info-box mb-3 text-dark">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text"><?php echo e(__('dashboard.MONTHLY EXPENSES')); ?></span>
                                <span class="info-box-number"><i class="fa fa-rupee"></i>
                                    <?php echo e(number_format(\App\Models\Expense::totalExpense() ,2) ?? ''); ?></span>
                            </div>
                        </div>
                    </a>
                </div>
    ...
    <div class="row">
                     ...
                     <?php if(count($getstudentbirthday) > 0): ?>  
                  <div class="col-md-4">
                     <div class="card card-warning" >
                    <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-bell"> <?php echo e(__('Birthday Notification')); ?></i> </h3>
                            <div class="card-tools">
                        ...
                        <div class="card-body">
                            ...
                            <marquee direction="up" scrollamount="4" id="test" onMouseOver="document.all.test.stop()"
                                ...
                                <ul class="todo-list ui-sortable" data-widget="todo-list">
                                    <?php if(!empty($getstudentbirthday)): ?>
                              
                                    <?php $__currentLoopData = $getstudentbirthday; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 
                                    <li class="">
                                        <a href="<?php echo e(url('admissionView')); ?>">
                                            <span class="text text-dark"><?php echo e($item->first_name ?? ''); ?><?php echo e($item->last_name ?? ''); ?></span>
                            ...
                            <marquee direction="up" scrollamount="4" id="newnotic" onMouseOver="document.all.newnotic.stop()"
                                ...
                                <ul class="todo-list ui-sortable" data-widget="todo-list">
                                   <?php if(!empty($noticeBoard)): ?>
                                    ...
                                    <li class="">
                                      <a href="<?php echo e(url('notice_board/view')); ?>/<?php echo e($item->id); ?>">
         ...
         <!--   <?php if(count($noticeBoard) > 0): ?> 
                    <div class="col-md-6">
                     <div class="card card-warning">
                    <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-bell"><?php echo e(__('dashboard.Notifications')); ?> </i> </h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                    <i class="fa fa-minus"></i>
                                </button>
  ...
  -->
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-8">
                                        <input type="text" class="form-control form-control-border" id="task"
                                            name="task" placeholder="<?php echo e(__('dashboard.Enter Task')); ?>...">
                                    </div>
                                    <div class="col-md-4 col-4">
                                        <button type="button" class="add_task btn btn-primary float-right btn-xs"><i
                                                class="fa fa-plus"></i> <?php echo e(__('common.Add')); ?></button>
                                    </div>
                                </div>
      ...
      <div class="card card-danger">
                    ...
                    <div class="card card-primary" style="display:none !important">
                        <div class="card-header">
                            <h3 class="card-title"> <?php echo e(__('dashboard.Area Chart')); ?> </h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                    <i class="fa fa-minus"></i>
                                </button>
                ...
                <div class="col-md-6">
                   <div class="card card-danger">
<div class="card-header">
<h3 class="card-title"><?php echo e(__('dashboard.Teacher Attendance Chart')); ?> </h3>
<div class="card-tools">
<button type="button" class="btn btn-tool" data-card-widget="collapse">
<i class="fa fa-minus"></i>
</button>
...
<canvas id="pieChart" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 487px;" width="487" height="250" class="chartjs-render-monitor"></canvas>
                    ...
                    <div class="card card-info" style="display:none !important">
                        <div class="card-header">
                            <h3 class="card-title"> <?php echo e(__('dashboard.Line Chart')); ?> </h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                    <i class="fa fa-minus"></i>
                                </button>
                  ...
                  <!--  <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title"> <?php echo e(__('dashboard.Bar Chart')); ?> </h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                    <i class="fa fa-minus"></i>
                                </button>
             ...
             <!--       <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title"> <?php echo e(__('dashboard.Stacked Bar Chart')); ?></h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                    <i class="fa fa-minus"></i>
                                </button>
           ...
           <!-- <div class="row">
                <div class="col-md-3">
                    <div class="sticky-top mb-3">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"> <?php echo e(__('dashboard.Draggable Events')); ?></h4>
                            </div>
                            <div class="card-body">
                                <div id="external-events">
                                    <div class="external-event bg-success ui-draggable ui-draggable-handle"
                                        style="position: relative;"><?php echo e(__('dashboard.Lunch')); ?></div>
                                    <div class="external-event bg-warning ui-draggable ui-draggable-handle"
                                        style="position: relative;"><?php echo e(__('dashboard.Go home')); ?></div>
                                    <div class="external-event bg-info ui-draggable ui-draggable-handle"
                                        style="position: relative;"><?php echo e(__('dashboard.Do homework')); ?></div>
                                    <div class="external-event bg-primary ui-draggable ui-draggable-handle"
                                        style="position: relative;"><?php echo e(__('dashboard.Work on UI design')); ?></div>
                                    <div class="external-event bg-danger ui-draggable ui-draggable-handle"
                                        style="position: relative;"><?php echo e(__('messages.Holiday')); ?></div>
                                    <div class="checkbox">
                                        <label for="drop-remove">
                                            <input type="checkbox" id="drop-remove"><?php echo e(__('dashboard.remove after drop')); ?> </label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title"><?php echo e(__('dashboard.Create Event')); ?></h3>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="input-group">
                                    <input id="new-event" type="text" class="form-control"
                                        placeholder="<?php echo e(__('dashboard.Event Title')); ?>">
                                    <div class="input-group-append">
                                        <button id="add-new-event" type="button" class="btn btn-primary"><?php echo e(__('messages.Add')); ?></button>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    $(function () {
        ...
        var donutData = {
            ...
            datasets: [
                {
                    data: [ 
                    <?php echo e($chartAttendanceStudents['Present']); ?>,<?php echo e($chartAttendanceStudents['Absent']); ?>,<?php echo e($chartAttendanceStudents['Work_From_Home']); ?>,<?php echo e($chartAttendanceStudents['Half_Day']); ?>,<?php echo e($chartAttendanceStudents['Holiday']); ?>],
      ...
      //  var pieData = donutData;
         var pieData = {
            ...
            datasets: [
                {
                    data: [ 
                    <?php echo e($chartAttendanceTeachers['Present']); ?>,<?php echo e($chartAttendanceTeachers['Absent']); ?>,<?php echo e($chartAttendanceTeachers['Work_From_Home']); ?>,<?php echo e($chartAttendanceTeachers['Half_Day']); ?>,<?php echo e($chartAttendanceTeachers['Holiday']); ?>],
                    backgroundColor: ['#00a65a', '#f56954',  '#f39c12', '#00c0ef', '#3c8dbc', '#d2d6de'],
                }
            ]
        }
...
var token_no = "<?php echo e(env('SOFTWARE_TOKEN_NO')); ?>";
                   $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusoft/public_html/demo3/resources/views/dashboard/admin_dashboard.blade.php ENDPATH**/ ?>