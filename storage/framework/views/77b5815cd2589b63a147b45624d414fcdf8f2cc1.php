...
<div class="content-wrapper">
   ...
   <section class="content pt-3">
    ...
    <div class="card card-outline card-orange">
        ...
        <h3 class="card-title"><i class="fa fa-th-large"></i> &nbsp;<?php echo e(__('Add Stationary Request')); ?> </h3>
        ...
        <a href="<?php echo e(url('viewStoreRequest')); ?>" class="btn btn-primary  btn-sm" title="View"><i class="fa fa-eye"></i> <?php echo e(__('View Stationary Bills')); ?> </a>
        </div>
        
        </div>  
        
                   <form id="quickForm" action="<?php echo e(url('addStationaryRequest')); ?>" method="post" >
                <?php echo csrf_field(); ?> 
                <input type='hidden' value='search' name='submit' />
            		...
            		<div class="col-md-4">
            			<div class="form-group"> 
            				<label><?php echo e(__('Search By Admission Number')); ?></label>
            				<input type="text" class="form-control" id="admissionNo" name="admissionNo" placeholder="Type Admission No" value="<?php echo e($search['admissionNo'] ?? ''); ?>">
            		    </div>
            		</div>                     	
                        <div class="col-md-1 ">
          ...
          $admissionNo = DB::table('admissions')->where('admissionNo',$search['admissionNo'])->whereNull('deleted_at')->first();
           $class = DB::table('class_types')->where('id', $admissionNo->class_type_id ?? '')->whereNull('deleted_at')->first();
            ?>
              ...
              <input type='hidden' value='<?php echo e($admissionNo->id ?? ""); ?>' name='admission_id' id='admission_id' />
              <input type='hidden' value='<?php echo e($admissionNo->class_type_id ?? ""); ?>' name='class_type_id' id='class_type_id' />
             <div class='page'>
<table style="border-bottom: 0px solid;width:100%;padding:10px" >
	...
	<tr style="text-align:center;">
      ...
      <p style="margin-bottom: 10px;"><b >Address </b> <?php echo e($getSetting['address'] ?? ''); ?></p>
   ...
   <table width="100%" style="border-collapse: collapse; border: 1px solid #000;">
        <tbody>
             ...
             <tr>
                ...
                <td style="border: 1px solid #000; padding: 8px;"><?php echo e($admissionNo->admissionNo ?? 'N/A'); ?></td>
                <td class="border_none" style="border: none;"></td>
                <td class="border_none" style="border: none;"></td>
            </tr>
            <tr>
                <th style="border: 1px solid #000; padding: 8px;">Name</th>
                <td style="border: 1px solid #000; padding: 8px;"><?php echo e($admissionNo->first_name ?? 'N/A'); ?></td>
                <th style="border: 1px solid #000; padding: 8px;">Father's Name</th>
                <td style="border: 1px solid #000; padding: 8px;"><?php echo e($admissionNo->father_name ?? 'N/A'); ?></td>
            </tr>
            <tr>
                <th style="border: 1px solid #000; padding: 8px;">Class</th>
                <td style="border: 1px solid #000; padding: 8px;"><?php echo e($class->name ?? ''); ?></td>
                <th style="border: 1px solid #000; padding: 8px;">Mobile</th>
                <td style="border: 1px solid #000; padding: 8px;"><?php echo e($admissionNo->mobile ?? 'N/A'); ?></td>
            </tr>
...
<script>
 ...
 var pendingValueTotal = 0;
  ...
  const storeItems = <?php echo json_encode($storeItems, 15, 512) ?>;
...
var admission_id = $('#admission_id').val();
            ...
            $.ajax({
                ...
                type: 'POST',
                data: {
                    _token: '<?php echo e(csrf_token()); ?>', // Add the CSRF token for Laravel
                    items: items,
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusoft/public_html/demo3/resources/views/store_management/addStationaryRequest.blade.php ENDPATH**/ ?>