                ...
                <table class="table table-bordered table-striped dataTable dtr-inline ">
                  ...
                  <tbody id="trColor">
                            <?php if(!empty($data)): ?>
                              ...
                              //dd($character);
                              ?>
                                <tr style="cursor:pointer; " class="fillData" data-id="<?php echo e($item['id'] ?? ''); ?>" data-admission_type_id="<?php echo e($item['admission_type_id'] ?? ''); ?>" data-old="<?php echo e($character ?? '0'); ?>" data-school_name="<?php echo e($getSetting['name'] ?? ''); ?>" data-class_type_id="<?php echo e($item['class_type_id'] ?? ''); ?>" data-registration_no="<?php echo e($item['admissionNo'] ?? ''); ?>" 
...
</script>                 <?php /**PATH /home/rusoft/public_html/demo3/resources/views/certificate/evente_certificate/evente_search.blade.php ENDPATH**/ ?>