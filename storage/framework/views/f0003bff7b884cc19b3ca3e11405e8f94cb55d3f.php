...
<div class="content-wrapper">
   ...
   <section class="content pt-3">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card card-outline card-orange">
                    ...
                    <h3 class="card-title"><i class="fa fa-trello"></i> &nbsp;<?php echo e(__('hostel.Add Room')); ?> </h3>
                    <div class="card-tools">
                    <a href="<?php echo e(url('room_view')); ?>" class="btn btn-primary  btn-sm"><i class="fa fa-eye"></i><?php echo e(__('common.View')); ?>  </a>
        ...
        <form id="quickForm" action="<?php echo e(url('room_add')); ?>" method="post">
        <?php echo csrf_field(); ?>
        <div class="row m-2">
            <div class="col-md-3">
...
unset($__errorArgs, $__bag); ?>                  			
            ...
            <div class="col-md-3">
        	  ...
        	  <div class="col-md-3">
    			<label style="color:red;"><?php echo e(__('hostel.Room Category')); ?>*</label>
				<select class="form-control select2 <?php $__errorArgs = ['room_category'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?> room_category select2" id="room_category" name="room_category">
                    <option value=""><?php echo e(__('common.Select')); ?></option>
                    <option value="1">AC</option>
                    <option value="2">Non AC</option>
                </select>
                 <?php $__errorArgs = ['room_category'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>                  			
            ...
            <div class="col-md-3">
                <table class="_table w-100" id="tableId">
                                <thead>
                                  <tr>
                                    <th width="80%" style="color:red;"><?php echo e(__('hostel.Room Name/No.')); ?>*</th>
                                     <th width="20%"></th>
                                  </tr>
                                </thead>
                                  <tbody id="table_body">
...
unset($__errorArgs, $__bag); ?>" type="text" required name="name[]" id="name" placeholder="<?php echo e(__('hostel.Room Name/No.')); ?>" value="<?php echo e(old('name')); ?>">
                                        </td>
                                        <td style="width: 92px;">
...
$(document).ready(function() {
    ...
    count++;
        $('#table_body').append('<tr id="appendRow_'+count+'" ><td colspan="12"><input class="form-control" type="text" required name="name[]" id="name" placeholder="<?php echo e(__('hostel.Room Name/No.')); ?>" value="<?php echo e(old('name')); ?>"></td><td style="width: 92px;"><div class="action_container"><button type="button" class="btn btn-primary btn-xs addmoreprodtxtbx" id="clonebtn"><i class="fa fa-plus"></i></button><button type="button" class="btn btn-danger btn-xs removeprodtxtbx" id="removerow"><i class="fa fa-trash"></i></button></div></td> </tr>');
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusoft/public_html/demo3/resources/views/hostel/room/add.blade.php ENDPATH**/ ?>