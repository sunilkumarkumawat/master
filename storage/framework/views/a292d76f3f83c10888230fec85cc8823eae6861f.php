...
<section class="content pt-3">
      <div class="container-fluid">
          ...
          <div class="col-12">
            <div class="card card-outline card-orange">
                    ...
                    <div class="card-tools">
                     <a href="<?php echo e(url('cc/form/add')); ?>" class="btn btn-primary  btn-sm" ><i class="fa fa-plus"></i><?php echo e(__('common.Add')); ?>  </a>
        ...
        <form id="quickForm" action="<?php echo e(url('cc/form/index')); ?>" method="post" >
            <?php echo csrf_field(); ?> 
            <div class="row m-2">
                <div class="col-md-2">
                      <div class="form-group">
                        <label class="required"><?php echo e(__('certificate.Admission No.')); ?></label>
                  ...
                  <tbody>
                      ...
                      <?php if(!empty($data)): ?>
                        ...
                        <tr>
                                ...
                                <td><?php echo e($item['achievement_for']); ?></td>
                                <td><?php echo e(date('d-m-Y', strtotime($item['iessu_date'])) ?? ''); ?></td>
                                <td>
                                    <a href="<?php echo e(url('cc/form/edit',$item->id)); ?>" title="Edit"><i class="fa fa-edit text-primary"></i></a>
                                    ...
                                    <a href="<?php echo e(url('cc_print',$item->id)); ?>" target="blank" title="Print"><i class="fa fa-print  text-success"></i></a>
                                </td>
                            </tr>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
...
<div class="modal" id="Modal_id">
  <div class="modal-dialog">
    <div class="modal-content" style="background: #555b5beb;">
      ...
      <!-- Modal body -->
      <form action="<?php echo e(url('certificate_delete')); ?>" method="post">
              	 <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusoft/public_html/demo3/resources/views/certificate/cc_form/index.blade.php ENDPATH**/ ?>