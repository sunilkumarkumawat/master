                                ...
                                <table id="example1" class="table table-bordered table-striped border  dtr-inline  student_data">
                                    <thead class="bg-primary">
                                        <tr role="row" class="colored_tr">
                                            ...
                                            <th><?php echo e(__('Father')); ?></th>
                                            <th><?php echo e(__('Mother')); ?></th>
...
<div class="modal" id="Modal_id">
  <div class="modal-dialog">
    <div class="modal-content" style="background: #555b5beb;">
      ...
      <!-- Modal Body -->
      <form action="<?php echo e(url('studentsAttendancdDelete')); ?>" method="post">
        <?php echo csrf_field(); ?>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default waves-effect" data-bs-dismiss="modal"><?php echo e(__('common.No')); ?></button>
          <button type="submit" class="btn btn-danger waves-effect"><?php echo e(__('common.Yes')); ?></button>
        </div>
      </form>
    </div>
  </div>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusoft/public_html/demo3/resources/views/students/attendance/attendance_add.blade.php ENDPATH**/ ?>