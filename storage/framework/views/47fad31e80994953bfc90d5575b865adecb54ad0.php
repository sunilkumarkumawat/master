...
.print_div{
    ...
    left: 0;
    width: 100%;
    background :url('<?php echo e(env("IMAGE_SHOW_PATH").'/default/print_file_samples/CertificateManagement/template09.jpg'); ?>');
...
<body>
   <div class="print_div">
        ...
        <div class="background_img">
            <img class="logo" src="<?php echo e(env('IMAGE_SHOW_PATH').'/setting/left_logo/'.$getSetting['left_logo']); ?>" alt="">
...
</html><?php /**PATH /home/rusoft/public_html/demo3/resources/views/master/printFilePanel/CertificateManagement/template09.blade.php ENDPATH**/ ?>