...
<body class='page'>
        ...
        <tbody>
            ...
            <tr>
                <td colspan="12">
                    ...
                    <p class="adres"><?php echo e($getSetting['address'] ?? ''); ?></p>
                </td>
            </tr>
    ...
    <table>
        <tbody>
            <tr>
                ...
                <td width="15%" style="border-bottom: 1px dotted black"><?php echo e($data['medium'] ?? ''); ?></td>
                <td></td>
                <td width="7%">S.R.No:</td>
                <td width="15%" style="border-bottom: 1px dotted black"><?php echo e($data['admissionNo'] ?? ''); ?></td>
            </tr>
        </tbody>
    </table>
    <table style="margin-top: 9px;">
        <tbody>
            <tr>
                ...
                <td width="15%" style="border-bottom: 1px dotted black"><?php echo e($data['from_year'] ?? ''); ?> - <?php echo e($data['to_year'] ?? ''); ?></td>
                <td width="12%"></td>
                <td width="22%">
                ...
                <td width="15%"></td>
                <td width="5%">Date</td>
                <td width="15%" style="border-bottom: 1px dotted black"><?php echo e(date('d-m-Y', strtotime($data['admission_date'])) ?? ''); ?></td>
            </tr>
        </tbody>
    </table>
                            ...
                            <table>
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td width='55%' class='' style='border-bottom:1px dotted black'><?php echo e($data['first_name'] ?? ''); ?> <?php echo e($data['last_name'] ?? ''); ?></td>
                                    </tr>
                                    <tr>
                            ...
                            <table>
                                <thead>
                                    <tr>
                                        ...
                                        <td width='80%' class='' style='border-bottom:1px dotted black'><?php echo e(date('d-m-Y', strtotime($data['dob'])) ?? ''); ?></td>
                                    </tr>
                                    <tr>
                                        <td width='25%' class='etr'>(b) In Hindi:</td>
                        ...
                        <table style="margin-top: 10px;">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <td width='10%' style='border-bottom:1px dotted black'><?php echo e($data['religion'] ?? ''); ?></td>

                                    <td width='10%' class='rtr'>CASTE:</td>
                                    <td width='10%' style='border-bottom:1px dotted black'><?php echo e($data['caste_category'] ?? ''); ?></td>

                                    <td width='10%' class='rtr'>CATEGORY:</td>
                                    <td width='10%' style='border-bottom:1px dotted black'><?php echo e($data['category'] ?? ''); ?></td>
                                </tr>
                        ...
                        <table>
                            <thead>
                                <tr style="margin-top: 10px;">
                                    ...
                                    <td width='85%' class='' style='border-bottom:1px dotted black'><?php echo e($data['blood_group'] ?? ''); ?></td>
                                </tr>
                            </thead>
                ...
                <table style=' margin-top:15px'>
                    ...
                    <thead>
                        <tr>
                            ...
                            <td width='43%' class='' style='border-bottom:1px dotted black'><?php echo e($data['father_name'] ?? '-'); ?></td>

                            <td width='8%' class='rtr'>MOB NO:</td>
                            <td width='45%' class='' style='border-bottom:1px dotted black'><?php echo e($data['father_mobile'] ?? '-'); ?></td>
                        </tr>
                        <tr>
                ...
                <table style=' margin-top:15px'>
                    ...
                    <thead>
                        <tr>
                            ...
                            <td width='43%' class='' style='border-bottom:1px dotted black'><?php echo e($data['mother_name'] ?? '-'); ?></td>

                            <td width='8%' class='rtr'>MOB NO:</td>
                            <td width='45%' class='' style='border-bottom:1px dotted black'><?php echo e($data['mother_mob'] ?? ''); ?></td>
                        </tr>
                        <tr>
                            <td class='etr'> (b) In Hindi:</td>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <td width='70%' class='' style='border-bottom:1px dotted black'><?php echo e($data['guardian_name'] ?? ''); ?></td>
                        </tr>
                        <tr>
                            <td width='25%' class='etr'> (b) In Hindi:</td>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <td width='850%' class='' style='border-bottom:1px dotted black'><?php echo e($data['address'] ?? ''); ?></td>
                        </tr>
                    </thead>
                </table>
            </tr>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <td width='57%' class='' style='border-bottom:1px dotted black'><?php echo e($data['relation_student'] ?? ''); ?></td>
                        </tr>
                    </thead>
                </table>
            </tr>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <td width='33%' class='' style='border-bottom:1px dotted black'><?php echo e($data['ClassTypes']['name'] ?? '-'); ?></td>
                        </tr>
                    </thead>
                </table>
            </tr>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <td width='28%' class='' style='border-bottom:1px dotted black'><?php echo e($data['school_namestudied_last_year'] ?? ''); ?></td>
                        </tr>
                    </thead>
                </table>
            </tr>
    ...
    <table>
        <tr>
            <td>I</td>
            <td class="border_line" style="width: 45%"><?php echo e($data['first_name'] ?? ''); ?> <?php echo e($data['last_name'] ?? ''); ?></td>
    ...
    <div class="sign">
        <h6></h6>
            <img src="<?php echo e(env('IMAGE_SHOW_PATH').'/setting/seal_sign/'.$getSetting['seal_sign']); ?>" style="width: 17%;height:50px;margin-top: -45px;margin-bottom: -37px;" onerror="this.src='<?php echo e(env('IMAGE_SHOW_PATH').'/default/seal.png'); ?>'">
...
</html><?php /**PATH /home/rusoft/public_html/demo3/resources/views/master/printFilePanel/StudentManagement/template03.blade.php ENDPATH**/ ?>