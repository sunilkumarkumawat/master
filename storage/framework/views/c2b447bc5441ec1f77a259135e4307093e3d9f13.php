         ...
         <div class="col-12 col-md-12">
            <div class="card card-outline card-orange">
               <div class="card-header bg-primary">
                  <h3 class="card-title"><i class="fa fa-leanpub"></i> &nbsp; <?php echo e(__('Admit Card')); ?> </h3>
               ...
               <div class="card-body">
                     <div class="row">
                        <div class='col-md-10'>
                        <form id="quickForm_find" action="<?php echo e(url('add/admit_card')); ?>" method="post">
                             <?php echo csrf_field(); ?> 
                            <div class="row">
                            <div class="col-md-3">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="card p-0">
                               <div class="card-body p-0" style="display: block;">
                                  <div class="table-responsive">
                                     <table class="table table-bordered dataTable dtr-inline card-outline card-orange">
                  ...
                  ?>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="student_name[]" id="student_name" class="form-control" readonly value="<?php echo e($item->first_name ?? ''); ?> <?php echo e($item->last_name ?? ''); ?>"></td>
                                    <td><input type="text" name="mobile[]" id="mobile" class="form-control" readonly value="<?php echo e($item->mobile ?? ''); ?>"></td>
                                    <td><input type="text" name="fathers_name[]" id="fathers_name" class="form-control" readonly value="<?php echo e($item->father_name ?? ''); ?>"></td>
                                    <td><input type="text" name="fathers_mobile[]" id="fathers_mobile" class="form-control" readonly value="<?php echo e($item->father_mobile ?? ''); ?>"></td>
                                    <td>
                                       ...
                                       <?php else: ?>
                                        ...
                                        <?php endif; ?>
                                        <input type="text" required name="exam_roll_no[]" placeholder="Exam Roll No." id="<?php echo e($key == 0 ? 'autoIncreament' : ''); ?>" <?php echo e(("exId_".$key) == "exId_0" ? ("") : ""); ?>  class="form-control autoIncreament exId_<?php echo e($key); ?>" value="<?php echo e($oldCard->exam_roll_no ?? old('exam_roll_no')); ?>">
                                    </td>
                               ...
                               <?php if($data1->count() != 0): ?>
                                    <div class="row" >
                                        <div class="col-md-12 mt-3 mb-3 text-center">
                                            <button form="Form1"type="submit" class="btn btn-primary">Save Roll No.</button>
                                        </div>
                                    </div>
                               <?php endif; ?>
                        </form>
...
var myString = arr.substring(1);
 ...
 window.location.replace(baseurl+'/exam_admit_card/'+exam+"/"+classs+"/"+myString);
//   $.ajax({
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusoft/public_html/demo3/resources/views/examination/offline_exam/admit_card/add.blade.php ENDPATH**/ ?>