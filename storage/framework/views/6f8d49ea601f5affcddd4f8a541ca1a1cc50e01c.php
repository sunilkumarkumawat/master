...
<div class="content-wrapper">
   ...
   <section class="content pt-3">
    ...
    <div class="card card-outline card-orange">
        ...
        <h3 class="card-title"><i class="fa fa-th-large"></i> &nbsp;<?php echo e(__('Add Store Item')); ?> </h3>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr data-new="false" data-id="<?php echo e($item->id ?? ''); ?>">
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusoft/public_html/demo3/resources/views/store_management/addStoreItem.blade.php ENDPATH**/ ?>