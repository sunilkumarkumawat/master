        ...
        <div class="col-12 col-md-12">
          <div class="card card-outline card-orange">
            ...
            <div class="col-12 col-md-3">
                   <form action="<?php echo e(url('updateByExcel')); ?>" method="post" enctype='multipart/form-data'>
              <?php echo csrf_field(); ?>
                   <div class="row">
                   <div class="col-8 col-md-8">    
    <div class="form-group">
                    <label><?php echo e(__('Update Student ')); ?><span class='text-danger'> [By Excel]</span></label>
                    <input type="file" class="form-control" name="excel" />
                  </div>
        </div>
        <div class="col-4 col-md-4">
                  <label class="text-white"><?php echo e(__('Update')); ?></label>
            ...
            <div class="col-md-8">
                <form action="<?php echo e(url('studentBulkImageUpload')); ?>" method="post" enctype='multipart/form-data'>
                  <?php echo csrf_field(); ?>
                   <div class="row">
                        <div class="col-md-2">    
                            <div class="form-group">
                        ...
                        <div class="col-md-2">    
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="session_id" name="session_id" required>
                                  ...
                                  <option value="<?php echo e($session->id ?? ''); ?>" ><?php echo e($session->from_year ?? ''); ?> - <?php echo e($session->to_year ?? ''); ?></option>
       ...
       <div class='row'>
                  <div class="col-12 col-md-12">
                   <form action="<?php echo e(url('admissionView')); ?>" method="post" >
              <?php echo csrf_field(); ?>
                   <div class="row">
        ...
        <div class="col-12 col-md-11 d-flex  p-2">
             <div class="col-12 col-md-11  p-2">
                        ...
                        <button type="submit" class="btn btn-primary" id="downloadZip"><?php echo e(__('Bulk Images Download [Zip]')); ?></button>
                </div>
                    <div class="col-12 col-md-11  p-2">
                         <input type='hidden' value='1' name='generate_user_name' />
                        <button type="submit" class="btn btn-primary"><?php echo e(__('Generate Password')); ?></button>
                    </div>
                </div>
                </div>
                </form>
                ...
                <div class="col-md-1">
					<div class="form-group">
						...
						<select class="form-control select2" id="category" name="category">
							...
							<option value="OBC" <?php echo e(('OBC' == $search['category']) ? 'selected' : ''); ?>>OBC</option>
							<option value="ST" <?php echo e(('ST' == $search['category']) ? 'selected' : ''); ?>>ST</option>
							<option value="SC" <?php echo e(('SC' == $search['category']) ? 'selected' : ''); ?>>SC</option>
							<option value="BC" <?php echo e(('BC' == $search['category']) ? 'selected' : ''); ?>>BC</option>
							<option value="GEN" <?php echo e(('GEN' == $search['category']) ? 'selected' : ''); ?>>GEN</option>
							<option value="SBC" <?php echo e(('SBC' == $search['category']) ? 'selected' : ''); ?>>SBC</option>
							<option value="Other" <?php echo e(('Other' == $search['category']) ? 'selected' : ''); ?>>Other</option>
				        </select>
					</div>
				</div>
                <div class="col-md-1">
                ...
                <div class="col-md-1">
					<div class="form-group">
						...
						<select class="form-control invalid select2" id="gender_id" name="gender_id">
							...
							<option value="<?php echo e($value->id); ?>" <?php echo e(($value->id == $search['gender_id']) ? 'selected' : ''); ?>><?php echo e($value->name ?? ''); ?></option>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							<?php endif; ?>
						</select>
					</div>
				...
				<div class="col-md-1">
					<div class="form-group">
						...
						<select class="form-control invalid select2" id="admission_type_id" name="admission_type_id">
							<option value=""><?php echo e(__('common.Select')); ?></option>
							<option value="1" <?php echo e((1 == $search['admission_type_id']) ? 'selected' : ''); ?>>Non RTE</option>
							<option value="2" <?php echo e((2 == $search['admission_type_id']) ? 'selected' : ''); ?>>RTE</option>
						</select>
						...
						<select class="form-control select2" id="blood_group" name="blood_group">
							<option value=""><?php echo e(__('common.Select')); ?></option>
								<?php if(!empty($bloodGroupType)): ?>
									...
									<option value="<?php echo e($bloodtype->name ?? ''); ?>" <?php echo e(($bloodtype->name == $search['blood_group']) ? 'selected' : ''); ?>><?php echo e($bloodtype->name ?? ''); ?></option>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								<?php endif; ?>
						</select>
				...
				<div class="col-md-2">
					<div class="form-group">
						...
						<select class="form-control select2" id="transport" name="transport">
						    <option value=""><?php echo e(__('common.Select')); ?></option>
							<option value="Yes" <?php echo e(('Yes' == $search['transport']) ? 'selected' : ''); ?>><?php echo e(__('Yes')); ?></option>
							<option value="No" <?php echo e(('No' == $search['transport']) ? 'selected' : ''); ?>><?php echo e(__('No')); ?></option>
						</select>
					</div>
				</div>
                ...
                <table id="studentList" class="table table-bordered table-striped dataTable dtr-inline nowrap">
                  <thead id='main_thead' class="bg-primary">
                    <tr role="row">
                      ...
                      <?php if($dataTable): ?>
                      <?php $__currentLoopData = $dataTable; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      
                        <th class="text-center  <?php echo e($val == 'Mobile' && Session::get('role_id') != 1 ? 'd-none' : ''); ?>"><?php echo e($val); ?></th>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      <?php endif; ?>
                      ...
                      <!--<th>Address</th>-->
                      <!--<th>Pincode</th>-->
                      <!--<th><?php echo e(__('Caste Category')); ?></th>-->
                       <!-- <th><?php echo e(__('Id Proof')); ?></th>
                      ...
                      <!--<th>Transport</th>-->
                      <th class="fixed_item"><?php echo e(__('common.Action')); ?></th>
                    </tr>
                  </thead>
                  <tbody id="product_list_show">
                    ...
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                    <tr>
                        <td><input type='checkbox' class='checkbox_id' data-admission_no="<?php echo e($item['admissionNo'] ?? ''); ?>" data-name="<?php echo e($item['first_name'] ?? ''); ?> <?php echo e($item['last_name'] ?? ''); ?>" data-mobile="<?php echo e($item['mobile'] ?? ''); ?>" data-father_name="<?php echo e($item['father_name'] ?? ''); ?>" value='<?php echo e($item->id); ?>'></td>                   
                    ...
                    <?php if($val == 'Image'): ?>
                        <td class="text-center">
                            <img width='50px'height='50px' style='border-radius:3px;padding:1px' class=" pointer" src="<?php echo e(env('IMAGE_SHOW_PATH').'profile/'.$item['image']); ?>" onerror="this.src='<?php echo e(env('IMAGE_SHOW_PATH').'default/user_image.jpg'); ?>'" data-img="<?php if(!empty($item->image)): ?> <?php echo e(env('IMAGE_SHOW_PATH').'profile/'.$item['image']); ?> <?php endif; ?>" >
                        </td>
                        <?php elseif($val == 'Name'): ?>
                        <td class="myBtn  editable" style="cursor:pointer;" data-id="<?php echo e($item->id ?? ''); ?>"data-field='first_name' data-modal='Admission'><?php echo e($item['first_name'] ?? ''); ?> <?php echo e($item['last_name'] ?? ''); ?></td>
                        <?php elseif($val == 'D.O.B.'): ?>
                        <td><?php if(!empty($item['dob'])): ?> <?php echo e(date('d-m-Y', strtotime($item['dob'])) ?? ''); ?><?php endif; ?></td>
                        <?php elseif($val == 'State'): ?>
                        <td><?php echo e($item['State']['name'] ?? '-'); ?></td>
                        <?php elseif($val == 'City'): ?>
                        <td><?php echo e($item['City']['name'] ?? '-'); ?></td>
                        <?php elseif($val == 'Blood Group'): ?>
                        <td><?php echo e($blood_group->name ?? '-'); ?></td>
                        <?php elseif($val == 'Gender'): ?>
                        <td><?php echo e($genderName->name ?? '-'); ?></td>
                        <?php elseif($val == 'Admission Type'): ?>
                    
                            <td class="text-center">
                                <?php if($item['admission_type_id'] == 1): ?>
                                    <p>Non RTE</p>
                                       
                                <?php elseif($item['admission_type_id'] == 2): ?>
                                  
                                    <p>RTE</p>
                                <?php endif; ?>
                            </td>
                        <?php elseif($val == 'Ad. Date'): ?>
                        <td>
                            <?php if(!empty($item['admission_date'])): ?>
                          
                                <?php echo e(date('d-m-Y', strtotime($item['admission_date'])) ?? ''); ?>

                      
                            <?php endif; ?>
                        </td>
                        <?php elseif($val == 'Class'): ?>
                           <td><?php echo e($item['ClassTypes']['name'] ?? '-'); ?></td>
                        <?php elseif($val == 'Mobile'): ?>
                        ...
                        <?php else: ?>
                        <td class="text-center editable"  data-id="<?php echo e($item->id ?? ''); ?>" data-field='<?php echo e($getAdmissionDatatableFields[$val]); ?>' data-modal='Admission'><?php echo e($item[$getAdmissionDatatableFields[$val]] ?? ''); ?> </td>
                    <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                    ...
                    <td class="fixed_item"> 
                        <div class="flex_centered">
                            <a href="<?php echo e(url('studentDetail')); ?>/<?php echo e($item['id'] ?? ''); ?>">
                                <button class="btn btn-success btn-xs" title="Admission View"><i class="fa fa-eye"></i></button>
                            </a>
                            <?php if($item->status != 3): ?>
                            <a href="<?php echo e(url('admissionStudentPrint')); ?>/<?php echo e($item->id); ?>" target="blank">
                            ...
                            <a href="<?php echo e(url('admissionEdit')); ?>/<?php echo e($item->id); ?>" target="blank">
                            ...
                            <?php else: ?>
                            <button class="btn btn-outline-danger ml-2 verify_admission" data-session_id="<?php echo e($item->session_id); ?>" data-id="<?php echo e($item->id); ?>" title="Verified Admission">Verified Admission</button>
                            <?php endif; ?>
                        </div>
                        <!--<?php if(empty($item->student_id_pdf_name)): ?>
                        <a href="<?php echo e(url('studentId_generator')); ?>/<?php echo e($item['id'] ?? ''); ?>" class="btn btn-info btn-xs"><i class="fa fa-file-pdf-o"></i></a>
                        <?php else: ?>
                        <a href="<?php echo e($item->student_id_pdf_name ?? ''); ?>" class="btn btn-success btn-xs">View PDF</a>
                        <?php endif; ?>-->
...
<div class="modal fade" id="verify_modal">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <form action="<?php echo e(url('verify_admission')); ?>" method="post">
            <?php echo csrf_field(); ?>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="session_id" id="sessionId" required>
                            ...
                            <?php if(!empty($getSession)): ?>
                                <?php $__currentLoopData = $getSession; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->id); ?>"><?php echo e($item->from_year ?? ''); ?> - <?php echo e($item->to_year ?? ''); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                        </select>
                    </div>
...
<div id="datatableFieldsModal" class="modal fade" role="dialog">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo e(url('saveAdmissionDatatableFields')); ?>" method='post'>
            <?php echo csrf_field(); ?>
        <div class="row">
            <?php if(!empty($getAdmissionDatatableFields)): ?>
            <?php $__currentLoopData = $getAdmissionDatatableFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $dataFields): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($key != 'SR.NO'): ?>
                <div class="col-md-3">
                    <div class="form-group clearfix">
                        <div class="icheck-success d-inline">
                        <input type="checkbox" class="checkbox" id="field_<?php echo e($dataFields ?? ''); ?>" name='fields[]' <?php echo e(in_array($key, $dataTable) ? 'checked' : ''); ?> value="<?php echo e($key ?? ''); ?>">
                            <label for="field_<?php echo e($dataFields ?? ''); ?>"><?php echo e($key ?? ''); ?></label>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
...
$(document).ready(function() {
  ...
  $('#studentList_wrapper').find('#btn-whatsapp').trigger('click');
               ...
               var dataCount = parseInt('<?php echo e(count($data)); ?>');
...
var dataValidations = sheet.getElementsByTagName('dataValidations')[0];
 ...
 while (index >= 0) {
    ...
    // Set the new text content
     tNode.textContent = '<?php echo e($setting->name); ?>\nAddress:<?php echo e($setting->address); ?>\nMobile:<?php echo e($setting->mobile); ?> Email:<?php echo e($setting->gmail); ?>\nDate:<?php echo e(date("d-M-Y")); ?>';
                    }
                },'pdf'
                ]
...
<script>
        ...
        // urls.push('<?php echo e(env('IMAGE_SHOW_PATH').'profile/'.$item['image']); ?>'+item.image)
        urls.push('<?php echo e(env('IMAGE_SHOW_PATH').'profile/'); ?>' + item.image);
        admissionNo.push(item.admissionNo)
             ...
             $(this).text('Downloading ...');
                var zip = new JSZip();
                var count = 0;
                var zipFilename = "<?php echo e($setting->name); ?>.zip";
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusoft/public_html/demo3/resources/views/students/admission/view.blade.php ENDPATH**/ ?>