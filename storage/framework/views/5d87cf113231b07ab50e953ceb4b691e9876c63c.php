      ...
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-12 pl-0">
                ...
                <h3 class="card-title"><i class="fa fa-inbox"></i> &nbsp;<?php echo e(__('Hostel Expenses Head')); ?></h3>
                <div class="card-tools">
                       <a href="<?php echo e(url('hostel_dashboard')); ?>" class="btn btn-primary  btn-sm"><i
                         ...
                         <form id="quickForm" action="<?php echo e(url('hostelExpensesHeadeAdd')); ?>" method="post" enctype="multipart/form-data">   
                        <?php echo csrf_field(); ?>
                            <div class="row m-2">
                                <div class="col-md-5">
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="col-md-12 pl-0">
                <div class="card card-outline card-orange ml-1">
                     <div class="card-header bg-primary">
                    <h3 class="card-title"><i class="fa fa-building"></i> &nbsp;<?php echo e(__('Hostel Expenses Head View')); ?> </h3>
                    <div class="card-tools">
                                ...
                                <tbody id="">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                    <a href="<?php echo e(url('hostelExpensesHeadeEdit',$item->id)); ?>" class="btn btn-primary  btn-xs ml-3" title="Edit Student Registration"><i class="fa fa-edit"></i></a>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusoft/public_html/demo3/resources/views/hostel/head/add.blade.php ENDPATH**/ ?>