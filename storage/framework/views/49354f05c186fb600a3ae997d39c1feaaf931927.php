...
<div class="content-wrapper">
   ...
   <section class="content pt-3">
    ...
    <div class="card card-outline card-orange">
            ...
            <h3 class="card-title"><i class="fa fa-address-book-o"></i> &nbsp;<?php echo e(__(' Sales Inventory ')); ?> </h3>
            <div class="card-tools">
            <a href="<?php echo e(url('sale_inventory_view')); ?>" class="btn btn-primary  btn-sm"><i class="fa fa-eye"></i><?php echo e(__('common.View')); ?> </a>
            ...
            <form id="quickForm" action="<?php echo e(url('sales_invantory_add')); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                <div class="row m-2">
                     <div class="col-md-2">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <span class="input-group-append">
                                <input id="admission_id" type="hidden" class="form-control"  name="admission_id"  >
                                <input id="student_name" type="text" class="form-control"  name="student_name"  value="<?php echo e(old('party_name') ?? ''); ?>" placeholder="Student Name" style="height: 35px;" required>
                  ...
                  <tbody id ="tbodynew">
                    ...
                    <td style="width: 215px;">
                        <div class="form-group">
                            ...
                            <input  type="text" id="stock_0" class="form-control">
                	   </div>
                    ...
                    <td>
                        <div class="form-group">
                            <input name="qty[]" id="qty_0" placeholder="Quantity" class="form-control qty" required onblur="calcSum(this.value,0),getItemQtyCheck(this.value,0)" maxlength="100" type="text"  value="<?php echo e(old('quantity')); ?>" onkeypress="javascript:return isNumber(event)">
                	   </div>
                    </td>
                   <td>
                        <div class="form-group">
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusoft/public_html/demo3/resources/views/invantory/sales_invantory/add.blade.php ENDPATH**/ ?>