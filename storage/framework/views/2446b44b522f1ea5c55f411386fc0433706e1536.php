              ...
              <?php if(!empty($data)): ?>
                ...
                <tr>
						...
						<td> 
						    ...
						    <a href="<?php echo e(url('salary_print')); ?>/<?php echo e($item->staff_id); ?>/<?php echo e($item->month_id); ?>" target="blank" class="btn btn-xs btn-success btn-xs ml-3" title="Print"><i class="fa fa-print"></i></a>  
                        </td>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusoft/public_html/demo3/resources/views/user/salary/view.blade.php ENDPATH**/ ?>