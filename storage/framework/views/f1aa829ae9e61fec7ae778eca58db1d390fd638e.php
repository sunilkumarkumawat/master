                            ...
                            <img src="<?php echo e(env('IMAGE_SHOW_PATH').'/setting/watermark_image/'.$getSetting['watermark_image']); ?>" alt="bg_logo" class="backhround_img">
                                            ...
                                            <tr>
                                                <td width="30%" style="padding: 0px 15px 0px;">
                                                    <div style="font-size:24px;letter-spacing:2px"><i>Date :</i> <strong style="border-bottom: 2px dotted black;"><?php echo e(date('d-m-Y', strtotime($data['iessu_date'])) ?? ''); ?></strong></div>
                                                </td>
                                                <td width="50%">
                                                    <div>
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    <div class="style10"><strong><i>This is certified that</i></strong> <i>Mstr/Ms.</i> <strong  style="border-bottom: 2px dotted black;"><?php echo e($data['first_name'] ?? ''); ?> <?php echo e($data['last_name'] ?? ''); ?></strong></div>
                                                    <div class="style10"><i>Son/Daughter Of </i><strong style="border-bottom: 2px dotted black;"> &nbsp;<?php echo e($data['stu_father_name'] ?? ''); ?></strong></div>
                                                    ...
                                                    <div class="style10"><i>To the best of my knowledge he/she bears a <strong  style="border-bottom: 2px dotted black;"><?php echo e($data['achievement_for'] ?? ''); ?>.</strong> achievement.</i> </div>
                                                    <div>
...
</html>--><?php /**PATH /home/rusoft/public_html/demo3/resources/views/master/printFilePanel/CertificateManagement/template01.blade.php ENDPATH**/ ?>