...
<div class="content-wrapper">
	<section class="content pt-3">
		<div class="container-fluid">
				...
				<div class="col-12 col-md-12">
					<div class="card card-outline card-orange">
						<div class="card-header bg-primary">
							<h3 class="card-title"><i class="fa fa-edit"></i> &nbsp; <?php echo e(__('certificate.Edit Event Certificate')); ?></h3>
            ...
            <div class="card-body">
                <form id="quickForm" action="<?php echo e(url('evente/certificate/edit')); ?>/<?php echo e(($data->id)); ?>" method="post" >
                     <?php echo csrf_field(); ?>
             <!--    <div class="row">
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusoft/public_html/demo3/resources/views/certificate/evente_certificate/edit.blade.php ENDPATH**/ ?>