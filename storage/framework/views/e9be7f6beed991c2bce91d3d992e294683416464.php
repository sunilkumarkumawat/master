                <table class="table table-bordered">
                  <thead>
                    <tr>
                       ...
                       <th class="text-center"><?php echo e(__('hostel.Ad. No.')); ?></th>
                  ...
                  <tbody id="trColor">
                            <?php if($data->count() > 0): ?>
                                ...
                                data-admission_no="<?php echo e($item['admissionNo'] ?? ''); ?>" 
                                data-admission_id="<?php echo e($item['id'] ?? ''); ?>" 
                                data-hostel="<?php echo e($item['hostel'] ?? ''); ?>" 
                                data-first_name="<?php echo e($item['first_name'] ?? ''); ?>" 
                                data-last_name="<?php echo e($item['last_name'] ?? ''); ?>" 
                                data-mobile="<?php echo e($item['mobile'] ?? ''); ?>" 
                                data-email="<?php echo e($item['email'] ?? ''); ?>" 
                                data-gender_id="<?php echo e($item['gender_id'] ?? ''); ?>"
                                data-father_name="<?php echo e($item['father_name'] ?? ''); ?>" 
                                data-mother_mobile="<?php echo e($item['mothers_mobile'] ?? ''); ?>" 
                                data-father_mobile="<?php echo e($item['father_mobile'] ?? ''); ?>" 
                                data-mother_name="<?php echo e($item['mother_name'] ?? ''); ?>" 
                                data-sig_img="<?php echo e($item['Signature_img'] ?? ''); ?>" 
                                data-dob="<?php echo e($item['dob'] ?? ''); ?>" 
                                data-college="<?php echo e($item['college'] ?? ''); ?>" 
                                data-course="<?php echo e($item['course'] ?? ''); ?>" 
                                data-guardian_whatsapp="<?php echo e($item['guardian_whatsapp'] ?? ''); ?>" 
                                 data-address="<?php echo e($item['address'] ?? ''); ?>" 
                                 data-duration_stay="<?php echo e($item['duration_stay'] ?? ''); ?>" 
                                 data-student_image="<?php echo e($item['image'] ?? ''); ?>" 
                                 data-father_image="<?php echo e($item['father_img'] ?? ''); ?>" 
                                 data-mother_image="<?php echo e($item['mother_img'] ?? ''); ?>" 
                                 data-sig1_img="<?php echo e($item['Signature1_img'] ?? ''); ?>" 
                                 data-sig2_img="<?php echo e($item['Signature2_img'] ?? ''); ?>" 
                                 data-sig4_img="<?php echo e($item['Signature4_img'] ?? ''); ?>" 
                                 data-Occupancy="<?php echo e($item['Occupancy'] ?? ''); ?>" 
                                data-guardian_photo="<?php echo e($item['guardian_photo'] ?? ''); ?>" 
                                 data-guardian_name="<?php echo e($item['guardian_name'] ?? ''); ?>" 
                                 data-guardian_address="<?php echo e($item['guardian_address'] ?? ''); ?>" 
                                 data-guardian_tel="<?php echo e($item['guardian_tel'] ?? ''); ?>" 
                                 data-guardian_mobile="<?php echo e($item['guardian_mobile'] ?? ''); ?>" 
                                 data-student_id_proof="<?php echo e($item['student_id_proof'] ?? ''); ?>" 
                                 data-college_id="<?php echo e($item['college_id'] ?? ''); ?>" 
                                 data-police_verification="<?php echo e($item['police_verification'] ?? ''); ?>" 
                                 data-covid_certificate="<?php echo e($item['covid_certificate'] ?? ''); ?>" 
                                 data-other_document="<?php echo e($item['other_document'] ?? ''); ?>" 
                                 data-father_adhar="<?php echo e($item['father_adhar'] ?? ''); ?>" 
                                 data-hostel_room="<?php echo e($item['hostel_room'] ?? ''); ?>" 
...
$(".fillData").on("click", function() {
  ...
  // alert(admission_no);
    ...
    var base =" <?php echo e(env('IMAGE_SHOW_PATH')); ?>";
...
</script>                 <?php /**PATH /home/rusoft/public_html/demo3/resources/views/hostel/hostel_assign/search_view.blade.php ENDPATH**/ ?>