            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-outline card-orange">
    					...
    					<h3 class="card-title"><i class="fa fa-shirtsinbulk"></i> &nbsp; <?php echo e(__('View Inventory ')); ?></h3>
    					    <div class="card-tools">
    					        <?php if(Session::get('role_id') == 1): ?>
    					        <a href="<?php echo e(url('invantory_add')); ?>" class="btn btn-primary"  ><i class="fa fa-plus"></i> <?php echo e(__('common.Add')); ?> </a> 
        			           ...
        			           <!-- <?php if(Session::get('role_id') !== 3): ?>
        			            <a href="<?php echo e(url('')); ?>" class="btn btn-primary  btn-sm" title="Back"><i class="fa fa-arrow-left"></i> Back</a> 
        			            <?php endif; ?>-->
    			            </div>
    				    </div>  
    				    <form id="quickForm" action="<?php echo e(url('view/invantory_item')); ?>" method="post" >
                            <?php echo csrf_field(); ?> 
                            <div class="card-body">
                                        ...
                                        <?php if(!empty($data)): ?>
                                            ...
                                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo e(url('invantory_edit')); ?>/<?php echo e($item['id'] ?? ''); ?>" class="btn btn-primary  btn-xs"  ><i class="fa fa-edit"></i></a>
                                                        <a href="javascript:;" data-id='<?php echo e($item['id']); ?>' data-bs-toggle="modal" data-bs-target="#Modal_id" class="deleteData btn btn-danger btn-xs ml-3"><i class="fa fa-trash-o"></i></a></td>
                                                </tr>    
...
<div class="modal" id="Modal_id">
  <div class="modal-dialog">
    <div class="modal-content" style="background: #555b5beb;">
      ...
      <!-- Modal body -->
      <form action="<?php echo e(url('invantory_delete')); ?>" method="post">
              	 <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusoft/public_html/demo3/resources/views/invantory/invantory/view.blade.php ENDPATH**/ ?>