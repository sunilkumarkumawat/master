...
<td  width='25%'class='line_height' style='border-bottom:1px dotted black'><?php echo e($data['first_name'] ?? ''); ?> <?php echo e($data['last_name'] ?? ''); ?></td>
<td  width='85%'class='line_height' ></td>
</tr>  

<tr>
<td width='15%' class='ltr line_height'>Mobile  :- </td>
<td  width='25%'class='line_height' style='border-bottom:1px dotted black'> <?php echo e($data['mobile'] ?? ''); ?> </td>
<td  width='85%'class='line_height' ></td>
</tr> 

<tr>
<td width='15%' class='ltr line_height'>Email :- </td>
<td  width='25%'class='line_height' style='border-bottom:1px dotted black'> <?php echo e($data['email'] ?? ''); ?></td>
<td  width='85%'class='line_height' ></td>
</tr>

<tr>
<td width='15%' class='ltr line_height'>DOB :- </td>
<td  width='25%'class='line_height' style='border-bottom:1px dotted black'> <?php echo e(date('d-m-Y', strtotime($data['dob'])) ?? ''); ?></td>
<td  width='85%'class='line_height' ></td>
</tr> 
...
<td  width='55%'class='line_height' style='border-bottom:1px dotted black'> <?php echo e($data['address'] ?? ''); ?></td>
<td  width='85%'class='line_height' ></td>
</tr>  
...
I assure to work with sincerity and dedication. <b>Teacher</b> (Job Position) in your company on <b><u><?php echo e(date('d-m-Y', strtotime($data['joining_date'])) ?? ''); ?></u></b>  (date of joining). 
I sincerely thank you for believing in me and offering me this position. I assure to work with sincerity and dedication.</p>-->

<p>I am immensely pleased to inform you that I accept the offer for the position of Teacher at your esteemed company. I acknowledge the same and confirm my readiness to join on <?php echo e(date('d-m-Y', strtotime($data['joining_date'])) ?? ''); ?>.</p>
...
<?php /**PATH /home/rusoft/public_html/demo3/resources/views/master/printFilePanel/StaffManagement/template03.blade.php ENDPATH**/ ?>