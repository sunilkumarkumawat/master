                ...
                <div class="col-md-2">
									<div class="form-group">
										...
										<select class="form-control" id="admission_type_id" name="admission_type_id">
											...
											<option value="1" <?php echo e(('1' == $search['admission_type_id']) ? 'selected' : ''); ?>>Yes</option>
											<option value="2" <?php echo e(('2' == $search['admission_type_id']) ? 'selected' : ''); ?>>No</option>
										</select>
                 ...
                 <tbody>
                     ...
                     <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $stu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <tr>
                         ...
                         <td>
                             <?php echo e($stu['class_type_id'] ?? ''); ?>

                         </td>
                         <td>
                             <?php echo e($stu['mobile'] ?? ''); ?>

                         </td>
                         <td>
                             <?php echo nl2br($stu['pendings'] ?? ''); ?>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusoft/public_html/demo3/resources/views/fees/dues/duesList.blade.php ENDPATH**/ ?>