                        <table id="example1" class="table table-bordered table-striped dataTable dtr-inline ">
                            <thead class="bg-primary">
                                <tr role="row">
                                    ...
                                    <th><?php echo e(__('hostel.Bed Name/No.')); ?></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(url('bed_edit')); ?>/<?php echo e($item['id'] ?? ''); ?>" class="btn btn-primary  btn-xs" title="Edit Floor" ><i class="fa fa-edit"></i></a> 
                                ...
                                <?php else: ?>
                                <tr><td colspan="3" class="text-center"><?php echo e(__('hostel.No Bed Found')); ?> !</td></tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
...
<script>
  ...
  $('#delete_id').val(delete_id); 
                        ...
                        <div class="modal" id="Modal_id">
                          <div class="modal-dialog">
                            <div class="modal-content" style="background: #555b5beb;">
                              ...
                              <form action="<?php echo e(url('bed_delete')); ?>" method="post">
                                      	 <?php echo csrf_field(); ?>
                        ...
                        <?php /**PATH /home/rusoft/public_html/demo3/resources/views/hostel/bed/bed_search.blade.php ENDPATH**/ ?>