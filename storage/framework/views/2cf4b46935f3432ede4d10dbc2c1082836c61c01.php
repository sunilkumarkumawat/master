  ...
  <div class="col-md-12 pr-0 <?php echo e(($getPermission->add == 1) ? '' : 'd-none'); ?>">
            <div class="card card-outline card-orange mr-1">
             <div class="card-header bg-primary">
							...
							<div class="card-tools"> <a href="<?php echo e(url('invantory_dashboard')); ?>" class="btn btn-primary  btn-sm"><i class="fa fa-arrow-left"></i><?php echo e(__('common.Back')); ?></a> </div>
						</div>
						<form id="quickForm" action="<?php echo e(url('invantory_item_add')); ?>" method="post" > 
						    <?php echo csrf_field(); ?>						
...
unset($__errorArgs, $__bag); ?>" type="text" id="name" name="name" placeholder="<?php echo e(__('common.Name')); ?>"> 
...
unset($__errorArgs, $__bag); ?>								    
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input class="form-control  <?php $__errorArgs = ['hsn_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" type="text" id="hsn_code" name="hsn_code" placeholder="Hsn Code"> 
...
unset($__errorArgs, $__bag); ?>								    
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input class="form-control  <?php $__errorArgs = ['unit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" type="text" id="unit" name="unit" placeholder="Unit"> 
...
unset($__errorArgs, $__bag); ?>								    
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input class="form-control  <?php $__errorArgs = ['mrp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" type="text" id="mrp" name="mrp" placeholder="Mrp"> 
                                        <?php $__errorArgs = ['mrp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>								    
            ...
            <div class="card card-outline card-orange ml-1">
             <div class="card-header bg-primary">
            <h3 class="card-title"><i class="fa fa-archive"></i> &nbsp;<?php echo e(__(' Inventory Item')); ?> </h3>
          ...
          <tbody>
              ...
              <?php if(!empty($data)): ?>
                ...
                <tr <?php if($item['available_stock'] <= 0 ): ?> style="background: #ff00006e;"<?php endif; ?>>
                        <td><?php echo e($i++); ?></td>
            ...
            $sold = DB::table('inventory_sale_details')->where('inventory_item_id',$item['id'])->whereNull('deleted_at')->sum('qty');
                    ...
                    $stock = $purchased - $sold;
                        ...
                        <?php echo e((Int)($stock ?? 0 )); ?></td>
                   
                        <?php if($getPermission->edit == 1 || $getPermission->deletes == 1): ?>
                            <td>
                                <?php if($getPermission->edit == 1): ?>
                                <a href="<?php echo e(url('invantory_item_edit')); ?>/<?php echo e($item->id); ?>" class="btn btn-primary  btn-xs ml-3" title="Edit Complaint"><i class="fa fa-edit"></i></a> 
								<?php endif; ?>
...
<div class="modal" id="Modal_id">
	<div class="modal-dialog">
		<div class="modal-content" style="background: #555b5beb;">
			...
			<form action="<?php echo e(url('invantory_item_delete')); ?>" method="post"> 
			    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusoft/public_html/demo3/resources/views/invantory/invantory_item/add.blade.php ENDPATH**/ ?>