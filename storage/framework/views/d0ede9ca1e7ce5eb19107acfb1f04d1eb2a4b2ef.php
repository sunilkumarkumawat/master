        ...
        <div class="row">
                                    ...
                                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:;" data-id='<?php echo e($item['id']); ?>' data-bs-toggle="modal" data-bs-target="#Modal_id" class="deleteData btn btn-primary btn-xs ml-3" title="Delete Hostel"><i class="fa fa-trash-o"></i></a>
                                            </td>
                                        </tr>
            ...
            <div class="col-md-4 pr-0">
                <div class="card card-outline card-orange mr-1">
                 <div class="card-header bg-primary">
                <h3 class="card-title"><i class="fa fa-hospital-o"></i> &nbsp;<?php echo e(__('hostel.Add Hostel')); ?></h3>
                <div class="card-tools">
                <!--<a href="<?php echo e(url('students/add')); ?>" class="btn btn-primary  btn-sm" ><i class="fa fa-plus"></i> Add</a>
                <a href="<?php echo e(url('students_dashboard')); ?>" class="btn btn-primary  btn-sm" ><i class="fa fa-arrow-left"></i> Back</a>-->
                 <a href="<?php echo e(url('hostel_dashboard')); ?>" class="btn btn-primary  btn-sm" ><i class="fa fa-arrow-left"></i><?php echo e(__('common.Back')); ?></a>
                    ...
                    <form id="quickForm" action="<?php echo e(url('hostel_add')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <div class="row m-2">
                        <div class="col-md-12">
...
unset($__errorArgs, $__bag); ?>" type="text" name="name" id="name" placeholder="<?php echo e(__('hostel.Hostel Name')); ?>" value="<?php echo e(old('name')); ?>">
...
unset($__errorArgs, $__bag); ?>" type="text" name="per_unit_rate" id="per_unit_rate" placeholder="<?php echo e(__('Per Unit Rate')); ?>" value="<?php echo e(old('per_unit_rate')); ?>">
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusoft/public_html/demo3/resources/views/hostel/hostel/add.blade.php ENDPATH**/ ?>