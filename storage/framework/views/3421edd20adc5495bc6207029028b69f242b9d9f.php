...
<table style="background:#6639b5;color:white; padding: 30px;">
	...
	<tr style="text-align:center;">
      ...
      <td width='25%'>
          ...
          <img class="img_bwm" src="<?php echo e(env('IMAGE_SHOW_PATH').'/profile/'.$data['image'] ?? ''); ?>" onerror="this.src='<?php echo e(env('IMAGE_SHOW_PATH').'/common_images/user_image.jpg'); ?>'">
          <?php else: ?>
          <img class="img_bwm" src="<?php echo e(env('IMAGE_SHOW_PATH').'/student_icon.png'); ?>" onerror="this.src='<?php echo e(env('IMAGE_SHOW_PATH').'/common_images/user_image.jpg'); ?>'">
          <?php endif; ?> -->
      </td>
      </tr>
      <tr>
...
<td  width='85%'class='' style='border-bottom:1px dotted black'><?php echo e($data['first_name'] ?? ''); ?> <?php echo e($data['last_name'] ?? ''); ?></td>
    </tr>    
<tr>
<td width='15%' class='ltr fontweight'>Father's Name:</td>

<td  width='85%' class='' style='border-bottom:1px dotted black'><?php echo e($data['father_name'] ?? '-'); ?></td>
    </tr>    
<tr>
<td width='15%' class='ltr fontweight'>Father's Mobile:</td>

<td  width='85%' class='' style='border-bottom:1px dotted black'><?php echo e($data['mobile'] ?? '-'); ?></td>
    </tr>    
<tr>
<td width='15%' class='ltr fontweight'>Mother's Name:</td>

<td  width='85%' class='' style='border-bottom:1px dotted black'><?php echo e($data['mother_name'] ?? '-'); ?></td>
    </tr>    
</thead>
...
<td  width='20%'class='' style='border-bottom:1px dotted black'><?php echo e(date('d-m-Y', strtotime($data['dob'])) ?? ''); ?></td>
   
<td width='15%' class='rtr fontweight'>Gender:</td>

<td  width='50%' class='ltr' style='border-bottom:1px dotted black'>  <?php echo e($data['gender'] ['name'] ?? '-'); ?></td>
...
<td  width='90%'class='ltr' style='border-bottom:1px dotted black'><?php echo e($data['address'] ?? '-'); ?></td>
...
<td  width='40%'class='' style='border-bottom:1px dotted black'><?php echo e($data['mobile'] ?? '-'); ?></td>
   
<td width='10%' class='ltr fontweight'>Email:</td>
<td  width='40%'class='' style='border-bottom:1px dotted black'><?php echo e($data['email'] ?? '-'); ?></td>
   </tr>    
<tr>
<td width='10%' class='ltr fontweight'>Class:</td>

<td  width='40%'class='' style='border-bottom:1px dotted black'><?php echo e($data['ClassTypes']['name'] ?? '-'); ?></td>
   
<td width='12%' class='ltr fontweight'>ID Number :</td>
<td  width='40%'class='' style='border-bottom:1px dotted black'><?php echo e($data['id_number'] ?? '-'); ?></td>
   </tr>    
<tr>
<td width='15%' class='ltr fontweight'>Registration No. :</td>

<td  width='40%'class='' style='border-bottom:1px dotted black'><?php echo e($data['registration_no'] ?? ''); ?></td>
...
<?php /**PATH /home/rusoft/public_html/demo3/resources/views/master/printFilePanel/StudentManagement/template02.blade.php ENDPATH**/ ?>