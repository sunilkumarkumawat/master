  ...
  <table style ='margin-top:20px' >
      ...
      <tr>
       ...
       ?>
            ...
            <td style="border:1px solid black" class='ltr'><?php echo e($item->receipt_no  ?? ''); ?></td>
            <td style="border:1px solid black" class='rtr'><?php echo e($item->name  ?? ''); ?></td>
            <td style="border:1px solid black" class='rtr'><?php echo e($item->transition_id  ?? '-'); ?></td>
            <td style="border:1px solid black" class='rtr'><?php echo e($item->bank_name  ?? '-'); ?></td>
            <td style="border:1px solid black" class='rtr'><?php echo e($item['fees_name'] ?? ''); ?></td>
            <td style="border:1px solid black" class='rtr'><?php echo e(date('d-M-Y', strtotime($item['date'])) ?? ''); ?></td>
            <!--<td style="border:1px solid black" class='rtr'><?php echo e(number_format($item->discount ,2) ?? ''); ?></td>-->
            <td style="border:1px solid black" colspan="2" class='rtr'>₹ <?php echo e(number_format($item->total_amount ,2) ?? ''); ?></td>
            </tr>
...
" style="height:90px;"></td>
                ...
                <td style="text-align: right;border:1px solid black">₹ <?php echo e(number_format($data['total_assign'] ,2) ?? ''); ?></td>
            </tr>
            <tr>
                ...
                <td id="inNumber" style="text-align: right;border:1px solid black">₹ <?php echo e(number_format($total_amount ,2) ?? ''); ?></td>
            </tr>
            <!--<tr>
                ...
                <td style="text-align: right;border:1px solid black"><?php echo e($discount_amount  ?? ''); ?></td>
            </tr>-->
            <tr>
                ...
                <td style="text-align: right;border:1px solid black">₹ <?php echo e(number_format($data['total_assign']-$total_amount-$discount_amount ,2) ?? ''); ?></td>
            </tr>
            <tr style='border-top:1px solid black'>
               ...
               <?php
                ...
                <td><b id="inWords"> <?php echo e($words ?? ''); ?></b></td>
            </tr>
...
<!--</script>--><?php /**PATH /home/rusoft/public_html/demo3/resources/views/master/printFilePanel/FeesManagement/template03.blade.php ENDPATH**/ ?>