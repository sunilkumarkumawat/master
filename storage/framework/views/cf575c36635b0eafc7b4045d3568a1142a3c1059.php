...
<head>
<title>School | Expense Receipt</title>
  <meta charset="utf-8">
...
<body>
<?php echo $__env->make('print_file.print_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<table width="100%" style="border-bottom: 2px solid black;">
   
    <tr>
        <td width="10%"><b>Date</b></td>
        <td width="90%"><b>: <?php echo e(date('d-m-Y', strtotime($data['date'])) ?? ''); ?></b></td>
        ...
        <img src="<?php echo e(env('IMAGE_SHOW_PATH').'/setting/watermark_image/'.$getSetting['watermark_image']); ?>" onerror="this.src='<?php echo e(env('IMAGE_SHOW_PATH').'/default/rukmani_logo.png'); ?>'" alt="" class="backhround_img">
                  ...
                  <tr role="row" style="text-align:center;">
                      ...
                      <th style="border-right: 1px solid black;border-bottom: 1px solid black;"> P A R T I C U L A R S</th>
                 ...
                 <tr style="text-align:center;">
                    ...
                    <td style="border-right: 1px solid black;"><?php echo e($data['name'] ?? ''); ?> </td>
                    <td style="border-right: 1px solid black;"><?php echo e($data['quantity']); ?></td>
                    <td style="border-right: 1px solid black;"><?php echo e($data['rate']); ?></td>
                    <td style="border-right: 1px solid black;"><?php echo e($data['amount']); ?></td>
                  </tr>
...
<script type="text/javascript">
  window.print();
</script><?php /**PATH /home/rusoft/public_html/demo3/resources/views/print_file/expense/expense_print.blade.php ENDPATH**/ ?>