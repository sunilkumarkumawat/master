...
<body class="hold-transition login-page bg_image">
    ...
    <div class="login-box">
        <div class='flex_cards'>
            <a href="<?php echo e(url('admin/login')); ?>">
                <div class="elevated-card admin_card">
                    ...
                    <div class="logo-container">
                        ...
                        <img src="<?php echo e(env('IMAGE_SHOW_PATH')); ?>default/Icon_images/web-development_762714.png"
            ...
            <a href="<?php echo e(url('teacher/login')); ?>">
                <div class="elevated-card teacher_card">

                    <div class="logo-container">

                        <img src="<?php echo e(env('IMAGE_SHOW_PATH')); ?>default/Icon_images/presentation_1436664.png"
                            alt="Company Logo" class="logo">
            ...
            <a href="<?php echo e(url('student/login')); ?>">
                <div class="elevated-card student_card">

                    <div class="logo-container">

                        <img src="<?php echo e(env('IMAGE_SHOW_PATH')); ?>default/Icon_images/woman_4140047.png" alt="Company Logo"
                            class="logo">
...
<span style='color:black'>  Contact Details</span>
        ...
        <div class='information'>
            <a data-toggle="modal" data-target="#softwareDetailsModal" class="text-white pointer">
                <img src="<?php echo e(env('IMAGE_SHOW_PATH')); ?>default/Icon_images/info_5639164.png" alt="Company Logo"
                ...
                <div class="card-body pt-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-5 text-center">
                            <img src="<?php echo e(asset('public/images/default/tech_support.avif')); ?>" alt="user-avatar"
    ...
    <div class="overlay-wrapper">
        <div class="overlay dark">
            ...
            <section id="noInternetSection" class="d-none">
                <div>
                    <img class="connectionimg" src="<?php echo e(asset('public/images/default/no_internet.jpg')); ?>">
                    <h1>No Internet Connection</h1>
                    <p>Please check your internet connection and try again.</p>
                    <a href="<?php echo e(url('/')); ?>" class="refresh-button">Refresh</a>
                    <br><br>
                </div>
            </section>
 ...
 <!-- The Modal -->
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p><strong>Mobile:</strong> <?php echo e($setting->mobile ?? ''); ?></p>
                    <p><strong>Email:</strong> <?php echo e($setting->email ?? ''); ?></p>
                </div>
    ...
    <script src="<?php echo e(URL::asset('public/assets/school/js/update.js')); ?>"></script>
    <script> openToken('<?php echo e(env('SOFTWARE_TOKEN_NO')); ?>', 'login'); </script>
...
</html><?php /**PATH /home/rusoft/public_html/demo3/resources/views/auth/prelogin.blade.php ENDPATH**/ ?>