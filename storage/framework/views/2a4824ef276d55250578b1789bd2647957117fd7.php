				...
				<div class="col-12 col-md-12">
					<div class="card card-outline card-orange">
						<div class="card-header bg-primary">
							<h3 class="card-title"><i class="fa fa-certificate"></i> &nbsp; View Sport Certificate</h3>
							<div class="card-tools"> <a href="<?php echo e(url('sport/certificate/add')); ?>" class="btn btn-primary  btn-sm"><i class="fa fa-plus"></i><?php echo e(__('common.Add')); ?> </a> 
					 <a href="<?php echo e(url('certificate_dashboard')); ?>" class="btn btn-primary  btn-sm"><i class="fa fa-arrow-left"></i><?php echo e(__('common.Back')); ?> </a> </div>
						...
						<form id="quickForm" action="<?php echo e(url('sport/certificate/index')); ?>" method="post" >
                        <?php echo csrf_field(); ?> 
            <div class="row m-2">
                <div class="col-md-2">
                      ...
                      <?php if(!empty($data)): ?>
                        ...
                        <tr>
                                ...
                                <td>
                                      ...
                                      <a href="<?php echo e(url('sport/certificate/edit',$item->id)); ?>" title="Edit"><i class="fa fa-edit text-primary"></i></a>
                                     ...
                                     <a href="<?php echo e(url('sport_print',$item->id)); ?>" target="blank" title="Print"><i class="fa fa-print text-success"></i></a>
...
<div class="modal" id="Modal_id">
  <div class="modal-dialog">
    <div class="modal-content" style="background: #555b5beb;">
      ...
      <!-- Modal body -->
      <form action="<?php echo e(url('sport_delete')); ?>" method="post">
              	 <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusoft/public_html/demo3/resources/views/certificate/sports/index.blade.php ENDPATH**/ ?>