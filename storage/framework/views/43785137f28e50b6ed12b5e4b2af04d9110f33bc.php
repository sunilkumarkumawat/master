...
body{
    background-image: url('<?php echo e(env('IMAGE_SHOW_PATH').'/setting/left_logo/'.$getSetting['left_logo']); ?>');
...
<body>
    ...
    <table class="tablep">
        <thead>
            <tr>
            <th colspan="2"><img src="<?php echo e(env('IMAGE_SHOW_PATH').'/setting/left_logo/'.$getSetting['left_logo']); ?>" onerror="this.src='<?php echo e(env('IMAGE_SHOW_PATH').'/default/rukmani_logo.png'); ?>'" style="margin-left: -69%; width: 17%;"></th>
            ...
            <tr>
                <th colspan="">Date: <?php echo e(date('d-m-Y', strtotime($data['date'])) ?? ''); ?></th>
            ...
            <tr>
                ...
                <td class="i i3"><b><?php echo e($data['User']['first_name'] ?? ''); ?> <?php echo e($data['User']['last_name'] ?? ''); ?></b></td>
                <td class="c i i3 w"><b>Emp.ID</b></td>
                <td class="i i3"><?php echo e($data['employeeId'] ?? ''); ?></td>
            </tr>
        </thead>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="i3"><?php echo e(date('d-m-Y', strtotime($data['staffJoining_date'])) ?? ''); ?></td>
                   
                </tr>
                <tr>
                    <td class="c i3"><b> Contact No.</b></td>
                    <td class="i3">+91-<?php echo e($data['User']['mobile'] ?? ''); ?></td>
                    <td class="c i3"><b>Designation</b></td>
                    <td class="i3"><?php echo e($data['roleName'] ?? ''); ?></td>
                </tr>
                <tr>
                        <td class="c i3"><b>Aadhar No</b></td>
                        <td class="i3"><?php echo e($data['aadhaar_no'] ?? ''); ?></td>
                        <td class="c i3"><b> SSSM.ID.</b></td>
                        <td class="i3">NA</td>
                    </tr>
                    <tr>
                        <td class="c i3"><b>Bank Name</b></td>
                        <td class="i3"><?php echo e($data['bank_name'] ?? ''); ?></td>
                        <td class="c i3"><b>Account No.</b></td>
                        <td class="i3"><?php echo e($data['account_no'] ?? ''); ?></td>
                    </tr>
               <!-- <tr>
                    <td class="c i3"><b>PAN</b></td>
                    <td class="i3">EKAPK9678C</td>
                    <td class="c i3"><b>Salary Month</b></td>
                    <td class="i3"><b><?php echo e($data['month_id'] ?? ''); ?></b></td>
                </tr>
                 ...
                 <!--   <tr>
                        ...
                        <td class="i3"><?php echo e($data['email'] ?? ''); ?></td>
                    </tr>-->
    ...
    <table class="table2">
        ...
        <tbody>
           <tr>
            <td class="a">1</td>
            <td class="b">Basic salary(@ <?php echo e($data['basic_amt'] ?? ''); ?>)</td>
            <td class="a"><?php echo e($data['salary_day'] ?? ''); ?></td>
            <td class="a">0.00</td>
            <td class="a"><?php echo e($data['basic_amt'] ?? ''); ?></td>
         </tr>
         <tr>
            <td class="a">2</td>
            <td class="b">Present</td>
            <td class="a"><?php echo e($data['present'] ?? ''); ?></td>
            <td class="a">0.00</td>
            <td class="a">0.00</td>
         </tr>
         <tr>
            ...
            <td class="a"><?php echo e($data['absent'] ?? ''); ?></td>
            <td class="a">0.00</td>
            <td class="a">0.00</td>
         </tr>
         <tr>
         ...
         <tr>
            ...
            <td class="a e"></td>
            <td class="a">Total</td>
            <td class="a"><?php echo e($data['total_amount'] ?? ''); ?></td>
         </tr>
   <!--      <tr>
    ...
    <table class="k">
        <tbody>
           <p style="text-align: left;"><span><b>Term & Condition:- </b></span> <br>&nbsp;&nbsp;&nbsp;&nbsp;1.&nbsp;&nbsp; This salary /pay slip to be consider with Bank Salary Transaction/ cheque/ provided by company.<br>
            ...
            <p  class="g"><img class="image" src="<?php echo e(env('IMAGE_SHOW_PATH').'/setting/seal_sign/'.$getSetting['seal_sign']); ?>" onerror="this.src='<?php echo e(env('IMAGE_SHOW_PATH').'/default/seal.png'); ?>'" style="width:16%;"></p>

            <p class="p g" > <b>Director's Signature</b><br><br><br><br></p>
            <p class="footer_p"><span><i>1<sup>st</sup>Floor,Royal Plazz,F-42, Vidyadhar,Nagar,Jaipur,Rajasthan 302032</span><a href="mailto://<?php echo e($getSetting['gmail'] ?? ''); ?>"><span style="margin-left: 47%;"><?php echo e($getSetting['gmail'] ?? ''); ?></span></i></a>
...
<!--<script type="text/javascript">
window.print();
</script>--><?php /**PATH /home/rusoft/public_html/demo3/resources/views/print_file/staff_print/salary_slip_download.blade.php ENDPATH**/ ?>