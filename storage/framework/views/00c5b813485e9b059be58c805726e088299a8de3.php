      ...
      <div class="container-fluid">
         ...
         <div class="card card-primary">
            <div class="card-header bg-primary">
               <h5 class="card-title"><?php echo e(__('hostel.Student Fees Pay')); ?></h5>
               <div class="card-tools">
                  <a href="<?php echo e(url('hostel/fees/view')); ?>" class="btn btn-primary  btn-sm" title="Back"><i class="fa fa-eye"></i> <?php echo e(__('common.View')); ?></a>
               ...
               <div class="row">
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <form id="studentDetailsForm" method="post" action="<?php echo e(url('hostel/collect/fees')); ?>">
                           <?php echo csrf_field(); ?>
                           <select name="student_details" id="student_details" class="form-control select2 ">
                              ...
                              <option value="<?php echo e($value->admission_id); ?>" <?php echo e(( $value->admission_id == $serach['student_details'] ?? '' ) ? 'selected' : ''); ?>><?php echo e($value->first_name ?? ''); ?> <?php echo e($value->last_name ?? ''); ?></option>
                  ...
                  <div class="col-md-2 ">
                     <div class="form-group">
                        <label><?php echo e(__('hostel.Student Name')); ?></label>
                        <input type="text" name="student_name" placeholder="<?php echo e(__('hostel.Student Name')); ?>" placeholder="Student Name" id="student_name" class="form-control" readonly="" value="<?php echo e($data->first_name ?? ''); ?> <?php echo e($data->last_name ?? ''); ?>">
                  ...
                  <div class="col-md-2">
                     <div class="form-group">
                        <label><?php echo e(__('hostel.Student Father Name')); ?></label>
                        <input type="text" name="father_name" placeholder="<?php echo e(__('hostel.Student Father Name')); ?>" id="father_name" class="form-control" readonly="" value="<?php echo e($data->father_name ?? ''); ?>">
                     </div>
                  </div>
                  <div class="col-md-2 ">
                     <div class="form-group">
                        <label><?php echo e(__('hostel.Room Category')); ?></label>
                        <input type="text" name="room_category" placeholder="Room Category" id="room_category" class="form-control" readonly="" value="<?php echo e($data->room_category ?? ''); ?>">
                     </div>
                  </div>
                  ...
                  <div class="col-md-2 ">
                     <div class="form-group">
                        ...
                        <input type="text" name="HostelNo" id="HostelNo" class="form-control" readonly="" value="<?php echo e($data->admissionNo ?? ''); ?>">
                     </div>
                  </div>
                  <div class="col-md-2 ">
                     <div class="form-group">
                        <label><?php echo e(__('hostel.Room Name')); ?></label>
                        <input type="text" name="room_name" id="room_name" class="form-control" readonly="" value="<?php echo e($data->room_name ?? ''); ?>">
                     </div>
                  </div>
         ...
         <?php if(!empty($data)): ?>
         <form id="quickForm" method="post" action="<?php echo e(url('hostel/fees/pay')); ?>">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="admission_id" value="<?php echo e($data['admission_id'] ?? ''); ?>" readonly class="form-control">
            <input type="hidden" name="hostel_assign_id" value="<?php echo e($data['id'] ?? ''); ?>" readonly class="form-control">
            <div class="card card-primary" id="payment_detail">
               <div class="card-header">
                  <h5 class="card-title"><?php echo e(__('hostel.Payment Detail')); ?></h5>
               </div>
               <div class="card-body">
                        ...
                        <div class="row">
                           <div class="col-md-2">
                              <div class="form-group">
                                 ...
                                 <input type="number" name="receipt_no" placeholder="" value="<?php echo e($BillCounter ?? ''); ?>" readonly class="form-control">
                              </div>
                           </div>
                            <?php
                                if (!empty($data)) {
...
unset($__errorArgs, $__bag); ?>" type="number" name="hostel_amount" id="hostel_amount" value="<?php echo e($data->hostel_fees ?? '0'); ?>"> 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            ...
                            <label for="totalPayableAmount">Total Payable Amount:</label>
                               <div class="input-group">
                                    ...
                                    <input class="form-control" type="number" name="totalPayableAmount" id="totalPayableAmount" readonly="" value="<?php echo e($data->hostel_fees ?? '0'); ?>">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                    ...
                                    <input class="form-control" type="text" name="amount" value="<?php echo e($data->hostel_fees ?? '0'); ?>" id="amount" autocomplete="off" data-gtm-form-interact-field-id="2">
                                </div>
                            </div>
                         <div class="col-md-3">
                            <div class="form-group">
                       ...
                       <div class="col-md-4  payment_info_class" style="display: none;">
                          <div class="form-group">
                             <label><?php echo e(__('hostel.Payment Info')); ?></label>
                             <input type="text" name="payment_info" id="payment_info" value="" class="form-control">
                          </div>
                       </div>
                           
                       <div class="col-md-12">
                          <center><button type="submit" class="btn btn-success pay"><?php echo e(__('common.Submit')); ?></button></center>
                       </div>
                    </div>
                     </div>
                  </div>
         ...
         <div class="card card-primary">
            <div class="card-header">
               <h5 class="card-title"><?php echo e(__('hostel.Student Fees Detail')); ?></h5>
            </div>
            <div class="card-body">
                  ...
                  <div class="col-md-12">
                     <table class="table table-bordered table-striped dataTable no-footer" role="grid" style="margin-left: 0px;">
                        <thead>
                           ...
                           <th><?php echo e(__('hostel.Discount')); ?></th>
                           <th><?php echo e(__('Due Amount')); ?></th>
                        </thead>
                        <?php if(!empty($feesDetail)): ?>
                        <?php
                        $i = 1;
                        ?>
                        <?php $__currentLoopData = $feesDetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr role="row">
                           <td><a href="<?php echo e(url('hostel_invoice')); ?>/<?php echo e($detail->invoice_no); ?>/<?php echo e($detail->admission_id); ?>" target="blank" target="blank" title="Fees Print"><?php echo e($detail->invoice_no ?? ''); ?></a></td>
                           <td><?php echo e(date('d-m-Y', strtotime($detail->created_at)) ?? ''); ?></td>
                           <td><?php echo e($detail->total_amount ?? ''); ?></td>
                           <td><?php echo e($detail->paid_amount ?? ''); ?></td>
                           <td><?php echo e($detail->discount ?? ''); ?></td>
                           <td><?php echo e($detail->due_amount ?? ''); ?></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
                     </table>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusoft/public_html/demo3/resources/views/hostel/fees/collect.blade.php ENDPATH**/ ?>