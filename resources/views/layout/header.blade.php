...
<ul class="navbar-nav" style="margin-left: 73px; margin-top: 25px; color:black">
  ...
  <ul class="navbar-nav ml-auto flex_centerd_profile">
    ...
    <li class="nav-item">
      <a class="nav-link" href="{{url('happy_birthday')}}" title="Today Birthday">
      ...
      <div class="Display_none_mobile">
        <form action="{{url('changeBranch')}}" method="POST">
          ...
          <select class="selectDesign select2" id="branch_id" name="branch_id" onchange="this.form.submit()">
            ...
            <option value="{{ $branch->id ?? ''  }} " {{ ( $branch->id == Session::get('admin_branch_id')) ? 'selected' : '' }}>{{ $branch->branch_name ?? ''  }} </option>
            @endforeach
            @endif
          </select>
        </form>
...
<div id="overlay">
    <div class="overlay-content">
       ...
       <div class="darksoul-circular-nav" onmouseover="stopanim()" onmouseout="startanim()" id="svg">
        ...
        <a href="{{ url('teachers/index') }}" class="darksoul-circle-2">
        ...
        <a href="{{ url('admissionView') }}" class="darksoul-circle-4">
        ...
        <a href="{{ url('/') }}" class="darksoul-circle-5">
        ...
        <a href="{{ url('viewUser') }}" class="darksoul-circle-6">
        ...
        <a  href="{{ url('Fees/add') }}"  data-bs-toggle="tooltip" data-bs-placement="bottom" title="Fee Collect" class="darksoul-circle-8">
          
            <img  src='{{env("IMAGE_SHOW_PATH")}}default/pay_625599.png'/>
        </a>
