	...
	<section class="content pt-3">
		<div class="container-fluid">
            ...
            <div class="col-md-3 col-6">
                <a href="{{ url('digitalExamTerminal')}}" class="small-box-footer">
                <div class="small-box bg-primary">
                    <div class="inner">
                    <h4 class="mobile_text_title">{{ __('Digital Exam Terminal') }}</h4>
            ...
            <div class="col-md-3 col-6">
                <a href="{{ url('digitalAnalysisPanel')}}" class="small-box-footer">
                <div class="small-box bg-success">
                    <div class="inner">
                    <h4 class="mobile_text_title">{{ __('Exam Analysis') }}</h4>
                    <h4 class="mobile_text_title">
