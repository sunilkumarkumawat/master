...
<body>
    ...
    <div class="container pagination_height">
        <table width="100%" class="border_table" cellspacing="0" cellpadding="0" style="background-image: url('{{ env('IMAGE_SHOW_PATH').'/default/logo_opacity.png'}}');
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" border="2" >
                        <tr >
                            <td width="20%" style="text-align:center;padding:10px; border: 0px solid white;">
                                <img src="{{ env('IMAGE_SHOW_PATH').'/setting/left_logo/'.$getSetting['left_logo'] }}" onerror="this.src='{{ env('IMAGE_SHOW_PATH').'default/rukmani_logo.png' }}'"   width = "100%" >
                                </td>
            ...
            <tr>
                ...
                <td>: <b>{{$className->name ?? '' }}efd;lfj;kdg;kd</b></td>
                <td>Student Name</td>
                   ...
                   if(!empty($number))
                               ...
                               <td>
                                 ...
                                 $total_obtained += $marks;
                                  ...
                                  $make_grade = ($marks/$max[$item1->id])*100;
                                 // dd($marks);
                                 @endphp
                              ...
                              <!--{{ strtoupper($number->student_marks ?? '-')}}-->
                                ...
                                @if( $make_grade >=91 && $make_grade <=100 )
                                    A+
                                @elseif( $make_grade >=76 && $make_grade <=90)
                                A
                                @elseif( $make_grade >=61 && $make_grade <=75)
                                B
                                @elseif( $make_grade >=41 && $make_grade <=60)
                                C
                                @elseif( $make_grade >=0 && $make_grade <=40)
                                D
                              ...
                              -
                                ...
                                <td>
                                 ...
                                 $g_grade_right = ($total_obtained/$getMaximumTotal)*100;
                                
                                   @endphp
                                    
                                     @if( $g_grade_right >=91 && $g_grade_right <=100 )
                                    A+
                                @elseif( $g_grade_right >=76 && $g_grade_right <=90)
                                A
                                @elseif( $g_grade_right >=61 && $g_grade_right <=75)
                                B
                                @elseif( $g_grade_right >=41 && $g_grade_right <=60)
                                C
                                @elseif( $g_grade_right >=0 && $g_grade_right <=40)
                                D
                            ...
                            <tr>
                               ...
                               <td>
                                  ...
                                  <!--{{$number2 ?? 0}}-->
                                              ...
                                              @if( $g_grade_bottom >=91 && $g_grade_bottom <=100 )
                                    A+
                                @elseif( $g_grade_bottom >=76 && $g_grade_bottom <=90)
                                A
                                @elseif( $g_grade_bottom >=61 && $g_grade_bottom <=75)
                                B
                                @elseif( $g_grade_bottom >=41 && $g_grade_bottom <=60)
                                C
                                @elseif( $g_grade_bottom >=0 && $g_grade_bottom <=40)
                                D
                                ...
                                @endforeach
                                  ...
                                  <!--{{ $number3  }}-->
                                     ...
                                     @if( $great_g_grade_bottom >=91 && $great_g_grade_bottom <=100 )
                                    A+
                                @elseif( $great_g_grade_bottom >=76 && $great_g_grade_bottom <=90)
                                A
                                @elseif( $great_g_grade_bottom >=61 && $great_g_grade_bottom <=75)
                                B
                                @elseif( $great_g_grade_bottom >=41 && $great_g_grade_bottom <=60)
                                C
                                @elseif( $great_g_grade_bottom >=0 && $great_g_grade_bottom <=40)
                                D
