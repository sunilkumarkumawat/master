                                ...
                                <tr>
                                    ...
                                    <td>
                                       ...
                                       @else
                                        ...
                                        @endif
                                        <input type="text" required name="exam_roll_no[]" placeholder="Exam Roll No." id="{{$key == 0 ? 'autoIncreament' : ''}}" {{ ("exId_".$key) == "exId_0" ? ("") : "" }}  class="form-control autoIncreament exId_{{$key}}" value="{{ $oldCard->exam_roll_no ?? old('exam_roll_no')}}">
                                    </td>
