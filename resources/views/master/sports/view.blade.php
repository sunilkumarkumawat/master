				...
				<div class="col-12 col-md-12">
					<div class="card card-outline card-orange">
						<div class="card-header bg-primary">
							<h3 class="card-title"><i class="fa fa-support"></i> &nbsp; View Sports</h3>
							<div class="card-tools"> <a href="{{url('sports')}}" class="btn btn-primary  btn-sm"><i class="fa fa-plus"></i> Add</a> </div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<div class="card-body">
									<table id="example1" class="table table-bordered table-striped dataTable dtr-inline ">
										...
										@if(!empty($data)) 
											...
											<tr>
												...
												<td>
												<img src="{{ env('IMAGE_SHOW_PATH').'sports/'.$item['photo'] }}" onerror="this.src='{{ env('IMAGE_SHOW_PATH').'/student_image/profile_img.png' }}'" width="60px" height="60px">
												</td>
											<td>
												    <a href="{{url('sports_edit') }}/{{$item->id}}" class="btn btn-primary  btn-xs ml-3" title="Edit Sports"><i class="fa fa-edit"></i></a> 
...
<div class="modal" id="Modal_id">
	<div class="modal-dialog">
		<div class="modal-content" style="background: #555b5beb;">
			...
			<form action="{{ url('delete_sports') }}" method="post"> 
			    @csrf
