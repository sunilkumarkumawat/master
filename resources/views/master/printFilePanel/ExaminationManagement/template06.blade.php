...
<thead>
 ...
 @endif
  ...
  <table style="width:100%;margin-top: 25px;">
      <tr class="">
        <th class="table_bg"></th>
        @foreach($list_exam as $item)
        <th class="table_bg tableBorder ctc">{{$item->name ?? ''}}</th>
         @endforeach
      </tr>
      <tr class="">
        <td class="table_bg"><b>Subject(Trivial)</b></td>
        @foreach($list_exam as $item)
       <td  class="table_bg tableBorder ctc">Grade</td>
         @endforeach
      </tr>
  <tr class="">
    ...
    @foreach($list_subject as $key => $item_subject)
        ...
        @if($item_subject->other_subject == 1)
         ...
         <td class="AreaBorder ctc ">
            @php
                $grade = (($number->student_marks ?? 1) / $maximum_marks)*100;
            @endphp
            @if( $grade >=91 && $grade <=100 )
                A+
            @elseif( $grade >=76 && $grade <=90.99)
  ...
  <tr class="">
    <td style="width: 2%;"><b>Remarks:- </b></td>
    <td style="width: 10%;">FAIR</td>
  ...
  <tr class="">
   ...
   <td style="width: 18%;"><p>Class Teacher's Signature</p></td>
   <td style="width: 15%;"><p>Principal's Signature</p></td>
  </tr>
</table>  
