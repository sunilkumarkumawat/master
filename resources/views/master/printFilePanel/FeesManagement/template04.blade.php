  ...
  <table style ='margin-top:20px' >
      ...
      <tr>
        ...
        @foreach ($data['stuPaidDetail'] as $item)
            ...
            <td style="border:1px solid black" class='ctr'>{{$item->receipt_no  ?? '' }}</td>
            <td style="border:1px solid black" class='ctr'>{{date('d-m-Y', strtotime($item['date'])) ?? '' }}</td>
            <td style="border:1px solid black" class='ctr'>{{$item->name  ?? '' }}</td>
            <td style="border:1px solid black" class='ctr'>{{ number_format($item->discount ,2) ?? '' }}</td>
            <td style="border:1px solid black" class='ctr'>{{ number_format($item->total_amount ,2) ?? '' }}</td>
            </tr>
    ...
    <tfoot style='border:1px solid black'>
            ...
            <td rowspan='4' style="text-align: left;"></td>
                ...
                <td class="border_none ctr"><b>{{$data['total_assign'] ?? '' }}</b></td>
            </tr>
            <tr>
                ...
                <td class="border_none ctr" id="inNumber" ><b>{{$total_amount ?? '' }}</b></td>
            </tr>
            <tr>
                ...
                <td class="border_none ctr"><b>{{$discount_amount  ?? '' }}</b></td>
            </tr>
            <tr>
                ...
                <td class="border_none ctr"><b>{{$data['total_assign']-$total_amount-$discount_amount  ?? '' }}</b></td>
            </tr>
