...
<body>
                ...
                <div style="display: flex;font-family: sans-serif; margin: 45px auto;" class="page">
                    <div>
                        <!--<p style="margin: 0;">-->
            ...
            <div class="header">
                <div class="header-top">
                    ...
                    <div class="school-name">
                        ...
                        <h5 style="margin: 0;text-align:center;">Teacher Id Card 2024-2025</h5>
                        <div style="display: flex;">
                            ...
                            <div style="text-align:start;">
                                    ...
                                    <img class="img_bwm" src="{{ env('IMAGE_SHOW_PATH').'/profile/'.$data['image'] ?? '' }}" onerror="this.src='{{ env('IMAGE_SHOW_PATH').'/default/user_image.jpg' }}'" width="70px" height="90px" style="margin-top: 3px;">
                                <div >
