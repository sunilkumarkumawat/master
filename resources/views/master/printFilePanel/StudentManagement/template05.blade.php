...
<tr>
     <td colspan='3' style="font-size:13px;text-align:center;"><span>ADMISSION FORM</span></td>
...
<thead>
<tr>
<td width='10%' class='ltr'>Division:</td>

<td  width='40%'class='rtr' style='border-bottom:1px dotted black'></td>
   
<td width='10%' class='rtr'>District:</td>
...
<thead>
<tr>
<td width='10%' class='ltr'>Address:</td>
...
<td width='10%' class='ltr'>Nationality:</td>
<td  width='40%'class='rtr' style='border-bottom:1px dotted black'></td>
   </tr>    
<tr>
...
<tr>
<td width='10%' class='ltr'>Class:</td>

<td  width='40%'class='' style='border-bottom:1px dotted black'>{{ $data['ClassTypes']['name'] ?? '-' }}
