...
<DOCTYPE html>
    ...
    <div class="row ">
        ...
        <div class="col-sm-12 col-12">
            <p class="mb-0" style="color: red;">Admission No: {{$data->admissionNo ?? ''}}</p>
        </div>
        </div>
        <div class="row">
        ...
        <div class="col-sm-9 col-9">
        <p class="dotted data_name">{{ $data['ClassTypes']['name'] ?? '-' }}  
        ...
        <div class="col-12 col-12">
            <div class="row flex_details">
                ...
                <div class="col-4 text-center">
                      ...
                      @endphp
                    <div>
                        <img src="data:image/png;base64,{{ base64_encode($generatorPNG->getBarcode($data['admissionNo'], $generatorPNG::TYPE_CODE_128)) }}" style="width: 100%;height: 45px;">
                    </div>
                    <div class="date_text">
                        <span><b>Joined Date :</b> {{date('d-m-Y', strtotime($data['admission_date'])) ?? '' }}</span>
