                                        ...
                                        <td class="row">
                                            @if(!empty($hwDocument)) 
                                                @foreach($hwDocument as $key=>$info)
                                                    ...
                                                    <img src="{{ env('IMAGE_SHOW_PATH').'uploadHomework/'.$info->content_file }}" width="60px" height="60px" onerror="this.src='{{ env('IMAGE_SHOW_PATH').'/default/user_image.jpg' }}'">
                                                    <span class="">
                                                    ...
                                                    <a data-href="{{ env('IMAGE_SHOW_PATH').'uploadHomework/'.$info->content_file }}" data-upload_id="{{$info['upload_hw_id']}}"  class="viewModal_{{$info['upload_hw_id']}}  viewModal2 btn btn-warning btn-xs" title="View Assignment" ><i class="fa fa-eye"></i></a>     
                                                    </span>
