...
<table width="100%" style="border-bottom: 2px solid black;">
    ...
    <tr>
        ...
        <td width="90%"><b>: {{date('d-m-Y', strtotime($data['date'])) ?? '' }}</b></td>
        ...
        <img src="{{ env('IMAGE_SHOW_PATH').'/setting/watermark_image/'.$getSetting['watermark_image'] }}" onerror="this.src='{{ env('IMAGE_SHOW_PATH').'/default/rukmani_logo.png' }}'" alt="" class="backhround_img">
                 ...
                 <tr style="text-align:center;">
                    ...
                    <td style="border-right: 1px solid black;">{{ $data['name'] ?? ''  }} </td>
                    <td style="border-right: 1px solid black;">{{ $data['quantity']  }}</td>
                    <td style="border-right: 1px solid black;">{{ $data['rate']  }}</td>
                    <td style="border-right: 1px solid black;">{{ $data['amount']  }}</td>
                  </tr>
