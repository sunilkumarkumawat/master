			...
			<div class="BoxA border- padding"> 
				<div class="row">
					<div class="col-sm-2 txt-center">
						<img src="{{ env('IMAGE_SHOW_PATH').'/setting/left_logo/'.$getSetting['left_logo'] }}" width="150px" height="150px" />
					</div>
						  ...
						  <tbody>
							<tr>
							  <th scope="row txt-center">Office Copy
                                  <img class="user-img" src="default-user.jpg" width="120px" height="150px" onerror="this.src='{{ env('IMAGE_SHOW_PATH').'/student_image/nee.jpg' }}'">
                                </th>
							</tr>
							<tr>
