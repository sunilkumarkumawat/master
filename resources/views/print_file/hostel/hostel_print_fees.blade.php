...
$month = DB::table('months')->where('id',$data->month_id)->first();
...
<div class="col-sm-3 border-right"><b>: {{ $data['f_mobile'] ?? '' }}</b></div>
<div class="col-sm-2"><b>Fee Month</b></div>
<div class="col-sm-3 border-right"><b>: {{ $month->name ?? '' }}</b></div>
...
<div class="col-sm-2"><span class="style73">

    <img class="student_img" src="{{ env('IMAGE_SHOW_PATH').'profile/'.$data['student_image'] }}" onerror="this.src='{{ env('IMAGE_SHOW_PATH').'/default/user_image.jpg' }}'">
   </span></div>
</div>
</table>
...
<div class="col-sm-4 border-right text-left"><b>Date</b></div>
<div class="col-sm-4 border-right text-left"><b>Discount</b></div>
<div class="col-sm-2 border-right border-left text-center"><b>Amount</b></div>
</div>
<div class="row"style="border: 1px solid black;">
<div class="col-sm-2 border-left">{{ $data['receipt_no']  }}</div>
<div class="col-sm-4 border-right text-left">{{date('d-m-Y', strtotime($data['date'])) ?? '' }}</div>
<div class="col-sm-4 border-right text-left">{{ $data['discount'] ?? '' }}</div>
...
<td colspan="3"style="width:145px;"></td>
<td colspan="3"></td>
<td colspan="3" ><b>:</b> <b id="inNumber">{{ $data->discount ?? '-' }}</b></td>
...
<td colspan="3"><b>Total Collect Amount</b></td>
<td colspan="3"style="width:145px;"></td>
<td colspan="3"></td>
<td colspan="3" ><b>:</b> <b id="inNumber">{{ $data->total_amount-$data->discount ?? '-' }}</b></td>
