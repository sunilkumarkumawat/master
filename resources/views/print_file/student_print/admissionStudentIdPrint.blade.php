    ...
    <div class="row ">
        ...
        <div class="col-sm-10 text-center col-10" style="line-height: 16px;">
            ...
            <p style="font-size: 14px;">
                <b>{{$setting['address'] ?? ''}},{{$setting['City']['name'] ?? ''}} ,{{ $setting['State']['name'] ?? ''}} <br>{{ $setting['Country']['name'] ?? ''}},{{$setting['phonecode'] ?? ''}} </b>
            </p>
        </div>
        </div>
        ...
        <div class="col-sm-12 col-12">
            <div class="row flex_details">
                ...
                <div class="col-md-4 text-center">
                      ...
                      @endphp
                    <div>
                        <img src="data:image/png;base64,{{ base64_encode($generatorPNG->getBarcode($data['admissionNo'], $generatorPNG::TYPE_CODE_128)) }}">
                    </div>
                    <div class="date_text">
