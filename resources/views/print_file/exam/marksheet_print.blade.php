...
<div class="col-sm-3 text-left"><b>{{ $item['class'] ?? '' }}
...
<div class="col-sm-2 text-center p-2 border-right border-dark" style="border-width:2px !important;border-bottom:2px solid black;"><b>Notes</b></div>
  ...
  <table width="83.2%">
                                         <tr class="text-center" style="border-bottom:2px solid black;">
                                            <td ><small class="badge badge-info ">{{ $data['total_ques'] ?? ''}}</small></td>
                                            <td><small class="badge badge-success " style="       margin-left: 100%;">{{ $data['correct_ans'] ?? ''}}</small></td>
                                            <td><small class="badge badge-danger " style="    margin-left: 100%;">{{ $data['wrong_ans'] ?? ''}}</small></td>
                                            <td><small class="badge badge-warning " style="    margin-left: 170%;">{{ $data['skip_ques'] ?? ''}}</small></td>
                                            ...
                                            <td ><small class="badge badge-secondary " style="    width: 20% !important;margin-left: 48%;">{{ $data['time'] ?? ''}}</small></td>
                                        </tr>        
