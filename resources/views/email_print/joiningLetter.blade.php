...
<p style="text-align:left;margin-top:-10px">Your Registration to {{$getSetting['name'] ?? ''}} as <b>TEACHER</b>has been Successfully.</p>
...
<strong style="margin-top:20px"><i>Registration No. :- </i></strong>&nbsp; {{ $registration_no ?? '' }}<br>
<strong style="margin-top:20px"><i>Registration Date :- </i></strong>&nbsp; {{ $registration_date ?? '' }}<br>
<strong style="margin-top:20px"><i>Name:- </i></strong>&nbsp;{{ $first_name ?? '' }} {{ $last_name ?? '' }}<br>
<strong style="margin-top:20px"><i>Father/Husband name- </i></strong>&nbsp;{{ $father_name ?? '' }}<br>

<strong style="margin-top:20px"><i>Mobile no.:- </i></strong>&nbsp;{{ $mobile ?? '' }}<br>
<strong style="margin-top:20px"><i>Email:- </i></strong>&nbsp;{{ $email ?? '' }}<br>
<strong style="margin-top:20px"><i>Address:- </i></strong>&nbsp;{{ $address ?? '' }}<br>
<p style="text-align:left;color:cadetblue;font-size:23px">
