...
<strong><i>Date:- </i></strong>&nbsp;{{ $dateTime ?? '' }} <br>
<strong style="margin-top:20px"><i>Total Questions:- </i></strong>&nbsp;{{ $total_ques ?? '' }}<br>
<strong style="margin-top:20px"><i>Correct Answers:- </i></strong>&nbsp;{{ $correct_ans ?? '' }}<br>
<strong style="margin-top:20px"><i>Wrong Answers:- </i></strong>&nbsp;{{ $total_ques-$correct_ans ?? '' }}<br>
<strong style="margin-top:20px"><i>Skipped Answers:- </i></strong>&nbsp;{{ $skip_ques ?? '' }}<br>
<strong style="margin-top:20px"><i>Your Percentage is:- </i></strong>&nbsp;{{ $percentage ?? '' }}<br>
<strong style="margin-top:20px"><i>You completed the Quiz in :- </i></strong>&nbsp;{{ $time ?? '' }} <br>
</p>
