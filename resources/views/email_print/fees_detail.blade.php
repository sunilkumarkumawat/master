...
<p style="text-align:left;color:cadetblue;font-size:23px">{{$getSetting['name'] ?? ''}},&nbsp;Jaipur </p>

<p style="text-align:left;margin-top:-10px">Yor School Fees <i class="fa fa-rupee"></i> <b>{{ $pay_amt ?? '' }}</b> have been Collected Successfully.</p>
...
<div style="text-align:right; line-height:10px;margin-top:60px" >
		<p style="font-size:15px;line-height:20px;">School office,<br><br>{{$getSetting['name'] ?? ''}}</p>
