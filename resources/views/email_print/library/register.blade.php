...
<p style="text-align:left;color:cadetblue;font-size:23px">Welcome to the {{$getSetting['name'] ?? ''}} Library,&nbsp;Jaipur </p>

<p style="text-align:left;margin-top:-10px">Yor Registration to {{$getSetting['name'] ?? ''}} Library have been Successfully.</p>
...
<p style="line-height:35px;margin-top:30px">Welcome dear [  {{ $name ?? '' }}  ],<br><strong style="font-size:23px;" >{{$getSetting['name'] ?? ''}} Library<strong></p>
</div>

<div style="text-align:right; line-height:10px;margin-top:60px" >
		<p style="font-size:15px;line-height:20px;">Hostel office,<br><br>{{$getSetting['name'] ?? ''}} Library</p>
