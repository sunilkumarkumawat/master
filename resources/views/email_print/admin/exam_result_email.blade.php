...
Student Exam Report  </p>
		...
		@php 
                                    $exams=DB::table('exams')->whereDate('exam_date',date('Y-m-d'))->get();
...
<p class="style2">
							...
							<table class="table">
								...
								<tbody> 
								 @php
                                    ...
                                    $data= Helper::examData($exam_name->id);
	...
	@endforeach
		...
		<p style="font-size:15px;line-height:13px;">Principle office,<br><br>{{$getSetting['name'] ?? ''}}</p>
