...
<p style="text-align:left;color:cadetblue;font-size:23px">Welcome to the {{$getSetting['name'] ?? ''}} Hostel,&nbsp;Jaipur </p>

<p style="text-align:left;margin-top:-10px">Yor Registration to {{$getSetting['name'] ?? ''}} Hostel have been Successfully.</p>
