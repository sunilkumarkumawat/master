                          ...
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tr>
                              <td class="mini-block">
                                ...
                                {{ $address['name'] ?? ''  }} <br>
                                {{ $address['phone'] ?? ''  }}   {{ $address['alternate'] ?? ''  }} , {{ $address['email'] ?? '' }} <br>
                                {{ $address['address'] ?? ''  }} , {{ $address['city'] ?? ''  }} {{ $address['landmark'] ?? ''  }} <br>
            ...
            <tr>
                  ...
                  @if(!empty($orderDetails))
                    ...
                    <tr>
                        ...
                        <table cellspacing="0" cellpadding="0" width="100%">
                            ...
                            <td class="product">
                                <span style="color: #4d4d4d; font-weight:bold;">{{ $item['product_category'] ?? '' }}</span> <br />
              ...
              {{--          <span class="total-space">Tax</span>  <br />
                   ...
                   {{--     <span class="total-space">$13.02</span> <br />
                      ...
                      <span class="total-space" style="font-weight:bold; color: #4d4d4d">{{ $orderData['amount'] ?? '' }}</span>
                    </td>
                  </tr>  
                </table>
              </td>
