              ...
              @if(!empty($data))
                ...
                @php
                    $plans = \App\Models\library\LibraryPlan::Select('library_plans.*','library_time_slots.study_time')
                                             ...
                                             ->where('library_plans.invoice_id',$item->id)
                ...
                <td>
                    <a href="{{ url('invoice') }}/{{ $item['invoice_no'] ?? '' }}/{{ $item['admission_id'] ?? '' }}" class="btn btn-xs btn-primary"><i class="fa fa-file"></i></a>
                    <a href="{{ url('library_due_amount_pay') }}/{{ $item['id'] ?? '' }}" class="btn btn-xs btn-danger ">Pay Dues</a>
...
<div class="modal-dialog modal-dialog-centered">
  <div class="modal-content">
    ...
    <form action="{{ url('due_amount_reminder') }}" method="post">
        @csrf
