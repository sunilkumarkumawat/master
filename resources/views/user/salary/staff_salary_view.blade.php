				...
				<div class="col-12 col-md-12">
					<div class="card card-outline card-orange">
						<div class="card-header bg-primary">
							<h3 class="card-title"><i class="fa fa-shirtsinbulk"></i> &nbsp;{{ __('My Salary') }}</h3>
              ...
              @if(!empty($data))
                ...
                <tr>
						...
						<td> 
						    ...
						    <a href="{{ url('salary_print') }}/{{ $item->staff_id }}/{{ $item->month_id }}" target="blank" class="btn btn-xs btn-primary btn-xs ml-3" title="Print"><i class="fa fa-print"></i></a>  
                        </td>
