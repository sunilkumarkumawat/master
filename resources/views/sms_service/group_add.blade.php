   ...
   <section class="content pt-3">
    ...
    <div class="card card-outline card-orange">
        	<div class="card-header bg-primary">
                        @if(Session::get('') == 3)
                            <h3 class="card-title"><i class="fa fa-leanpub"></i> &nbsp; {{ __('Add Whatsapp Group') }}</h3>
                        @else						    
							<h3 class="card-title"><i class="nav-icon fas fa fa-leanpub"></i> &nbsp;{{ __('Add Whatsapp Group') }}</h3>
						@endif
        ...
        <section class="content">
            ...
            <div class="container-fluid">
				...
				@enderror
                	...
                	<input type='text' class='form-control @error("group_id") is-invalid @enderror' name='group_id' />
                	 @error('group_id')
					<span class="invalid-feedback" role="alert">
						<strong>{{ $message }}</strong>
					</span>
