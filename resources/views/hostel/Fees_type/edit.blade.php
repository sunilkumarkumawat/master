    ...
    <div class="row">
                                ...
                                @foreach ($get_data  as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:;"  data-bs-toggle="modal" data-bs-target="#Modal_id" class="deleteData btn btn-danger btn-xs ml-3" title="Delete Hostel"><i class="fa fa-trash-o"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                @endif
        ...
        <div class="col-md-4 pr-0">
            <div class="card card-outline card-orange mr-1">
                 <div class="card-header bg-primary">
                <h3 class="card-title"><i class="fa fa-edit"></i> &nbsp;{{ __('Edit Fees Type') }} </h3>
                <div class="card-tools">
                <!--<a href="{{url('students/add')}}" class="btn btn-primary  btn-sm" ><i class="fa fa-plus"></i> Add</a>
                ...
                <form id="quickForm" action="{{ url('fees_type_editt') }}/{{ $data['id'] ?? '' }}" method="post">
                @csrf
                <div class="row m-2">
                    <div class="col-md-12">
            			<label style="color:red;">{{ __('Fees Type Name') }}*</label>
            			<input class="form-control @error('fees_type') is-invalid @enderror" type="text" name="fees_type" id="fees_type" placeholder="Fess Type Name" value="{{ $data['fees_type'] ?? '' }}">
                         @error('fees_type')
