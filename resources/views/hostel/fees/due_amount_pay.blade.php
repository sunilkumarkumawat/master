    ...
    <div class="col-md-12">
        <div class="card card-primary">
            <div class="card-header">
             ...
             <form action="{{ url('hostel_due_amount_pay') }}/{{$data->id}}" method="post">
                @csrf
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                         ...
                                         <input class="form-control @error('amount') is-invalid @enderror" readonly="" type="number" name="hostel_amount" id="hostel_amount" value="{{$data->due_amount ?? ''}}"> 
                                        @error('amount')
