    ...
    <div class="row">
        ...
        <div class="col-md-4 pr-0">
            <div class="card card-outline card-orange mr-1">
                 <div class="card-header bg-primary">
                <h3 class="card-title"><i class="fa fa-edit"></i> &nbsp;{{ __('hostel.Edit Hostel') }} </h3>
                <div class="card-tools">
                <!--<a href="{{url('students/add')}}" class="btn btn-primary  btn-sm" ><i class="fa fa-plus"></i> Add</a>
                ...
                <form id="quickForm" action="{{ url('hostel_edit') }}/{{ $data['id'] ?? '' }}" method="post">
                @csrf
                <div class="row m-2">
                    <div class="col-md-12">
            			<label style="color:red;">{{ __('hostel.Hostel Name') }}*</label>
            			<input class="form-control @error('name') is-invalid @enderror" type="text" name="name" id="name" placeholder="Hostel Name" value="{{ $data['name'] ?? '' }}">
                         @error('name')
                	 ...
                	 <div class="col-md-6">
                			...
                			<input class="form-control @error('per_unit_rate') is-invalid @enderror" type="text" name="per_unit_rate" id="per_unit_rate" placeholder="{{ __('Per Unit Rate') }}" value="{{ $data['per_unit_rate'] ?? '' }}">
