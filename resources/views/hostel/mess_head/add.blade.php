      ...
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-12 pl-0">
                ...
                <h3 class="card-title"><i class="fa fa-inbox"></i> &nbsp;{{ __('hostel.Mess Expenses Heade') }}</h3>
                <div class="card-tools">
                       <a href="{{url('hostel_dashboard')}}" class="btn btn-primary  btn-sm"><i
                                        class="fa fa-arrow-left"></i>{{ __('common.Back') }} </a>
                </div>
                 </div>    
                         <form id="quickForm" action="{{ url('messExpanceAdd') }}" method="post" enctype="multipart/form-data">   
                        @csrf
                            <div class="row m-2">
                                <div class="col-md-5">
              ...
              <div class="col-md-12 pl-0">
                <div class="card card-outline card-orange ml-1">
                     <div class="card-header bg-primary">
                    <h3 class="card-title"><i class="fa fa-building"></i> &nbsp;{{ __('hostel.Mess Expenses Heade View') }} </h3>
                    <div class="card-tools">
                                    ...
                                    @endphp
                                        ...
                                        <tr>
                                           ...
                                           <!--<td>{{ $item['type'] ??'' }}</td>-->
                                            ...
                                            <td>
                                    <a href="{{url('messExpanceEdit',$item->id)}}" class="btn btn-primary  btn-xs ml-3" title="Edit Student Registration"><i class="fa fa-edit"></i></a>
...
<div class="modal" id="Modal_id">
  <div class="modal-dialog">
    <div class="modal-content" style="background: #555b5beb;">
      ...
      <form action="{{ url('messExpanceDelete') }}" method="post">
              	 @csrf
