        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-outline card-orange">
                    ...
                    <h3 class="card-title"><i class="fa fa-plus"></i> &nbsp;{{ __('hostel.Assign Students') }}</h3>
                   ...
                   <div class="row">
                    	...
                    	<div class="col-md-3 name" style="display:none;">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="admission_no" name="admission_no" placeholder="{{ __('hostel.Admission No.') }}" readonly value="{{$admissionBillCounter['counter'] +1 ?? ''}}" onkeypress="javascript:return isNumber(event)">
									</div>
								</div>
                    	  <div class="col-md-3 name" style="display:none;">
