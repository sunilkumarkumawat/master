                        <table id="example1" class="table table-bordered table-striped dataTable dtr-inline ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item['name']  }}</td>
                                    <td>
                                        <a href="{{ url('room_edit') }}/{{ $item['id'] ?? '' }}" class="btn btn-primary  btn-xs" title="Edit Floor" ><i class="fa fa-edit"></i></a> 
                                ...
                                @else
                                <tr><td colspan="3" class="text-center">No Room Found !</td></tr>
                                @endif
                            </tbody>
                        </table>
