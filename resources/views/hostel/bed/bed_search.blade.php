                        <table id="example1" class="table table-bordered table-striped dataTable dtr-inline ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item['name']  }}</td>
                                    <td>
                                        <a href="{{ url('bed_edit') }}/{{ $item['id'] ?? '' }}" class="btn btn-primary  btn-xs" title="Edit Floor" ><i class="fa fa-edit"></i></a> 
                                ...
                                @else
                                <tr><td colspan="3" class="text-center">{{ __('hostel.No Bed Found') }} !</td></tr>
                                @endif
                            </tbody>
                        </table>
                        ...
                        <div class="modal" id="Modal_id">
                          <div class="modal-dialog">
                            <div class="modal-content" style="background: #555b5beb;">
                              ...
                              <form action="{{ url('bed_delete') }}" method="post">
                                      	 @csrf
