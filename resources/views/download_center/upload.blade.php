      ...
      <div class="container-fluid">
        ...
        <div class="col-md-4 pr-0 {{($getPermission->add == 1) ? '' : 'd-none'}}">
            ...
            <div class="card-tools">
                ...
                <form id="quickForm" action="{{ url('upload/content') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row m-2">
                    	<div class="col-md-12">
                    ...
                    <div class="col-md-12">
                       <table id="example1" class="table table-bordered table-striped dataTable dtr-inline ">
                          ...
                          <tr role="row">
                              ...
                              @if($getPermission->deletes == 1 || $getPermission->edit == 1 || $getPermission->download == 1)
