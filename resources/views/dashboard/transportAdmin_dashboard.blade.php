          ...
          <div class="col-12 col-md-12">
            <div class="card card-outline card-orange">
                <div class="card-header bg-primary">
                    <h3 class="card-title"><i class="fa fa-home"></i> &nbsp; Transport Admin Dashboard </h3>
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-3">
                ...
                <div class="info-box mb-3 text-dark">
                    <span class="info-box-icon bg-success elevation-1"><i class="fa fa-bus"></i></span>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                ...
                <div class="info-box mb-3 text-dark">
                    <span class="info-box-icon bg-danger elevation-1"><i class="fa fa-road"></i></span>
                    <div class="info-box-content">
                        <span class="info-box-text">  TOTAL ROUTE</span>
                    <span class="info-box-number">{{\App\Models\Master\BusRoute::countBusRoute()}}</span>
                    </div>
                </div>
                </a>
            </div>
            <div class="col-12 col-sm-6 col-md-3">
                <a href="{{ url('stu_bus_view') }}">
                <div class="info-box mb-3 text-dark">
                    <span class="info-box-icon bg-primary elevation-1"><i class="fa fa-graduation-cap"></i></span>
                    <div class="info-box-content">
                        <span class="info-box-text">TOTAL BUS STUDENT</span>
                    <span class="info-box-number">{{\App\Models\Master\BusAssign::countBusAssign()}}</span>
                    </div>
                </div>
                </a>
            </div>    
            <div class="col-12 col-sm-6 col-md-3">
                ...
                <div class="info-box mb-3 text-dark">
                    ...
                    <span class="info-box-number"><i class="fa fa-rupee"></i> {{\App\Models\FeesDetail::totalCollection() }}</span>
                    </div>
                </div>
                </a>
            </div>             
            <div class="col-12 col-sm-6 col-md-3">
                ...
                <div class="info-box mb-3 text-dark">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text"> TOTAL EXPANCE</span>
