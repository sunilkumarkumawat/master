      ...
      <div class="container-fluid">
          ...
          <div class="col-12 col-md-12">
            <div class="card card-outline card-orange">
                <div class="card-header bg-primary">
                    <h3 class="card-title"><i class="fa fa-home"></i> &nbsp; Examination Dashboard</h3>
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <a href="{{ url('view/exam') }}">
                <div class="info-box mb-3 text-dark">
                    <span class="info-box-icon bg-success elevation-1"><i class="fa fa-leanpub"></i></span>
                    <div class="info-box-content">
                        <span class="info-box-text">TOTAL EXAM</span>
                    <span class="info-box-number">{{\App\Models\exam\Exam::countExam()}}</span>
                    </div>
                </div>
                </a>
            </div>  
            <div class="col-12 col-sm-6 col-md-3">
                <a href="{{ url('view/exam') }}">
                <div class="info-box mb-3 text-dark">
                    <span class="info-box-icon bg-danger elevation-1"><i class="fa fa-leanpub"></i></span>
                    <div class="info-box-content">
                        <span class="info-box-text">THIS MONTH EXAM</span>
                    <span class="info-box-number"> {{\App\Models\exam\Exam::thisMonthExam() }}</span>
                    </div>
                </div>
                </a>
            </div>
            <div class="col-12 col-sm-6 col-md-3">
                <a href="{{ url('view/result') }}">
                <div class="info-box mb-3 text-dark">
                    <span class="info-box-icon bg-primary elevation-1"><i class="fa fa-bar-chart-o"></i></span>
                    <div class="info-box-content">
                        <span class="info-box-text">EXAM RESULT</span>
                    <span class="info-box-number">{{\App\Models\exam\Exam::countExam()}}</span>
                    </div>
                </div>
                </a>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                ...
                <div class="info-box mb-3 text-dark">
                    <span class="info-box-icon bg-warning elevation-1"><i class="fa fa-check-square-o"></i></span>
                    <div class="info-box-content">
                        <span class="info-box-text">TOTAL QUESTIONS</span>
                    <span class="info-box-number">{{\App\Models\exam\Question::countQuestion() }}</span>
                    </div>
                </div>
                </a>
            </div>             
