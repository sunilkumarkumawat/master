          ...
          <div class="col-12 col-md-12">
            <div class="card card-outline card-orange">
                <div class="card-header bg-primary">
                    <h3 class="card-title"><i class="fa fa-home"></i> &nbsp; Accountant Dashboard</h3>
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-3">
                ...
                <div class="info-box mb-3 text-dark">
                    ...
                    <span class="info-box-number"><i class="fa fa-rupee"></i> {{ number_format(\App\Models\FeesDetail::totalCollection() ,2) ?? '' }}</span>
                    </div>
                </div>
                </a>
            </div>  
            <div class="col-12 col-sm-6 col-md-3">
                ...
                <div class="info-box mb-3 text-dark">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">TODAY FEES</span>
                    <span class="info-box-number"><i class="fa fa-rupee"></i> {{ number_format(\App\Models\FeesDetail::todayCollection() ,2) ?? '' }}</span>
                    </div>
                </div>
                </a>
            </div>
            <div class="col-12 col-sm-6 col-md-3">
                ...
                <div class="info-box mb-3 text-dark">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">THIS MONTH FEES</span>
                    <span class="info-box-number"><i class="fa fa-rupee"></i> {{ number_format(\App\Models\FeesDetail::thisMonthCollection() ,2) ?? '' }}</span>
                    </div>
                </div>
                </a>
            </div>    
            <div class="col-12 col-sm-6 col-md-3">
                ...
                <div class="info-box mb-3 text-dark">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text"> THIS SESSION FEES </span>
                    <span class="info-box-number"><i class="fa fa-rupee"></i> {{ number_format(\App\Models\FeesDetail::thisSessionCollection() ,2) ?? '' }}</span>
                    </div>
                </div>
                </a>
            </div>             
            <div class="col-12 col-sm-6 col-md-3">
                ...
                <div class="info-box mb-3 text-dark">
                    ...
                    <span class="info-box-number"><i class="fa fa-rupee"></i> {{ number_format(\App\Models\Expense::totalExpense() ,2) ?? '' }}</span>
                    </div>
                </div>
                </a>
            </div>
            <div class="col-12 col-sm-6 col-md-3">
                ...
                <div class="info-box mb-3 text-dark">
                    ...
                    <span class="info-box-number"><i class="fa fa-rupee"></i> {{ number_format(\App\Models\Expense::thisMonthExpense() ,2) ?? '' }}</span>
                    </div>
                </div>
                </a>
            </div>            
            <div class="col-12 col-sm-6 col-md-3">
                ...
                <div class="info-box mb-3 text-dark">
                    ...
                    <span class="info-box-number"><i class="fa fa-rupee"></i> {{ number_format(\App\Models\Expense::todayExpense() ,2) ?? '' }}</span>
                    </div>
                </div>
                </a>
            </div>
                <div class="col-12 col-sm-6 col-md-3">
                    <a href="{{ url('fees/ledger') }}">
                        <div class="info-box mb-3 text-dark">
                            <span class="info-box-icon bg-primary elevation-1"><i class="fa fa-bar-chart-o"></i></span>
                            <div class="info-box-content">
                                <span class="info-box-text">{{ __('dashboard.FEES LEDGER') }}</span>
                ...
                <div class="card-tools" style="width:70%;">
                                <div class="input-group pt-1">
                                    ...
                                    <div class="input-group-append">
                                        <button id="add-new-event" type="button" class="btn btn-primary">{{ __('messages.Add') }}</button>
                                    </div>
                                </div>
