	...
	<section class="content pt-3">
		<div class="container-fluid">
            ...
            <div class="row ">
             ...
             <form id="" class='col-md-7' action="{{ url('studentExcelAdd') }}" method="post" enctype="multipart/form-data">
							@csrf         
                        <div class="row ">
                            <!--<div class="col-md-2">-->
						...
						<form id="quickForm_addmission" action="{{ url('admissionAdd') }}" method="post" enctype="multipart/form-data">
							...
							<div class="row m-2">
								...
								<div class="col-md-2">
									...
									<!--	<input type="text" class="form-control" id="admission_no" name="admissionNo" placeholder="{{ __('student.Admission No.') }}"  
										...
										<input type="text" class="form-control invalid" id="admissionNo" name="admissionNo" placeholder="{{ __('student.Admission No.') }}" value="{{$BillCounter ?? ''}}" onkeypress="javascript:return isNumber(event)">
							...
							<!--<div class="col-md-2">
                                ...
                                <!--<div class="col-md-2">
									<div class="form-group">
										<label>{{ __('Is RTE Student') }}<span style="color:red;">*</span></label>
										<select class="form-control invalid" id="rte_student" name="rte_student">
											
											<option value="Yes" {{ ('Yes' == old('rte_student')) ? 'selected' : 'selected' }}>Yes</option>
											<option value="No" {{ ('No' == old('rte_student')) ? 'selected' : '' }}>NO</option>
										</select>
