      ...
      <div class="card-body login-card-body">
        ...
        <div class="input-group mb-3">
          ...
          <div class="row">
             ...
             <!--<div class="separator">
                    ...
                    <div class="form-group row mb-0">
                            <div class="col-md-12 text-center">
                                <a href='{{url("newStudentRegistration")}}'>
            ...
            <div class="row mt-3">
                <div class="col-7"><a href="{{ url('forgot_password') }}" class="text-white"><i class="fa fa-key"></i> Forgot Password ?</a></div>
                <div class="col-5 text-right"><a href="{{ url('login') }}" class="text-white"><i class="fa fa-user"></i> Change Role!</a></div>
            </div
  </div>
 </div>
 <!-- jQuery -->
