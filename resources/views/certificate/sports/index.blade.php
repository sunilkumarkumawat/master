				...
				<div class="col-12 col-md-12">
					<div class="card card-outline card-orange">
						<div class="card-header bg-primary">
							...
							<div class="card-tools"> <a href="{{url('sport/certificate/add')}}" class="btn btn-primary  btn-sm"><i class="fa fa-plus"></i>{{ __('common.Add') }} </a> 
					 <a href="{{url('certificate_dashboard')}}" class="btn btn-primary  btn-sm"><i class="fa fa-arrow-left"></i>{{ __('common.Back') }} </a> </div>
						</div>
						
						<form id="quickForm" action="{{url('sport/certificate/index')}}" method="post" >
                        @csrf 
            <div class="row m-2">
                <div class="col-md-2">
                      ...
                      @if(!empty($data))
                        ...
                        <tr>
                                ...
                                <td>
                                      ...
                                      <a href="{{url('sport/certificate/edit',$item->id)}}" title="Edit"><i class="fa fa-edit text-primary"></i></a>
                                     ...
                                     <a href="{{url('sport_print',$item->id)}}" target="blank" title="Print"><i class="fa fa-print text-success"></i></a>
...
<div class="modal" id="Modal_id">
  <div class="modal-dialog">
    <div class="modal-content" style="background: #555b5beb;">
      ...
      <!-- Modal body -->
      <form action="{{ url('sport_delete') }}" method="post">
              	 @csrf
